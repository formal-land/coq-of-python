...
Definition globals : string := "ethereum.constantinople.fork".
...
Axiom ethereum_constantinople_imports :
  AreImported globals "ethereum.constantinople" [ "vm" ].

Axiom ethereum_constantinople_blocks_imports :
  AreImported globals "ethereum.constantinople.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_constantinople_bloom_imports :
  AreImported globals "ethereum.constantinople.bloom" [ "logs_bloom" ].

Axiom ethereum_constantinople_fork_types_imports :
  AreImported globals "ethereum.constantinople.fork_types" [ "Address"; "Bloom"; "Root" ].

Axiom ethereum_constantinople_state_imports :
  AreImported globals "ethereum.constantinople.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_constantinople_transactions_imports :
  AreImported globals "ethereum.constantinople.transactions" [ "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "Transaction" ].

Axiom ethereum_constantinople_trie_imports :
  AreImported globals "ethereum.constantinople.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_constantinople_utils_message_imports :
  AreImported globals "ethereum.constantinople.utils.message" [ "prepare_message" ].

Axiom ethereum_constantinople_vm_interpreter_imports :
  AreImported globals "ethereum.constantinople.vm.interpreter" [ "process_message_call" ].
