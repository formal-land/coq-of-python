...
Definition globals : string := "ethereum.constantinople.vm.stack".
...
Axiom ethereum_constantinople_vm_exceptions_imports :
  AreImported globals "ethereum.constantinople.vm.exceptions" [ "StackOverflowError"; "StackUnderflowError" ].
