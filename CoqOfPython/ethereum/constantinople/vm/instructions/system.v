...
Axiom ethereum_constantinople_state_is_account_alive :
  IsGlobalAlias globals ethereum.constantinople.state.globals "is_account_alive".
...
Axiom ethereum_constantinople_utils_address_compute_contract_address :
  IsGlobalAlias globals ethereum.constantinople.utils.address.globals "compute_contract_address".
Axiom ethereum_constantinople_utils_address_compute_create2_contract_address :
  IsGlobalAlias globals ethereum.constantinople.utils.address.globals "compute_create2_contract_address".
...
Axiom ethereum_constantinople_vm___init___incorporate_child_on_error :
  IsGlobalAlias globals ethereum.constantinople.vm.__init__.globals "incorporate_child_on_error".
Axiom ethereum_constantinople_vm___init___incorporate_child_on_success :
  IsGlobalAlias globals ethereum.constantinople.vm.__init__.globals "incorporate_child_on_success".
...
Axiom ethereum_constantinople_vm_gas_GAS_CALL :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_CALL".
Axiom ethereum_constantinople_vm_gas_GAS_CALL_VALUE :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_CALL_VALUE".
Axiom ethereum_constantinople_vm_gas_GAS_CREATE :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_CREATE".
Axiom ethereum_constantinople_vm_gas_GAS_KECCAK256_WORD :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_KECCAK256_WORD".
Axiom ethereum_constantinople_vm_gas_GAS_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_NEW_ACCOUNT".
Axiom ethereum_constantinople_vm_gas_GAS_SELF_DESTRUCT :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_SELF_DESTRUCT".
Axiom ethereum_constantinople_vm_gas_GAS_SELF_DESTRUCT_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_SELF_DESTRUCT_NEW_ACCOUNT".
Axiom ethereum_constantinople_vm_gas_GAS_ZERO :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_ZERO".
Axiom ethereum_constantinople_vm_gas_REFUND_SELF_DESTRUCT :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "REFUND_SELF_DESTRUCT".
...
Axiom ethereum_constantinople_vm_gas_calculate_message_call_gas :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "calculate_message_call_gas".
Axiom ethereum_constantinople_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "charge_gas".
Axiom ethereum_constantinople_vm_gas_max_message_call_gas :
