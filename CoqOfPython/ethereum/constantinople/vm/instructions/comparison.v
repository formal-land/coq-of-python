...
Definition globals : string := "ethereum.constantinople.vm.instructions.comparison".
...
Axiom ethereum_constantinople_vm_gas_imports :
  AreImported globals "ethereum.constantinople.vm.gas" [ "GAS_VERY_LOW"; "charge_gas" ].
