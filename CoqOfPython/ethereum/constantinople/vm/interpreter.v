...
Definition globals : string := "ethereum.constantinople.vm.interpreter".
...
Axiom ethereum_constantinople_state_imports :
  AreImported globals "ethereum.constantinople.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "begin_transaction"; "commit_transaction"; "destroy_storage"; "increment_nonce"; "move_ether"; "rollback_transaction"; "set_code"; "touch_account" ].

Axiom ethereum_constantinople_vm_imports :
  AreImported globals "ethereum.constantinople.vm" [ "Message" ].

Axiom ethereum_constantinople_vm_gas_imports :
  AreImported globals "ethereum.constantinople.vm.gas" [ "GAS_CODE_DEPOSIT"; "charge_gas" ].

Axiom ethereum_constantinople_vm_precompiled_contracts_mapping_imports :
  AreImported globals "ethereum.constantinople.vm.precompiled_contracts.mapping" [ "PRE_COMPILED_CONTRACTS" ].

Axiom ethereum_constantinople_vm_imports :
  AreImported globals "ethereum.constantinople.vm" [ "Environment"; "Evm" ].

Axiom ethereum_constantinople_vm_exceptions_imports :
  AreImported globals "ethereum.constantinople.vm.exceptions" [ "AddressCollision"; "ExceptionalHalt"; "InvalidOpcode"; "OutOfGasError"; "Revert"; "StackDepthLimitError" ].
...
Axiom ethereum_constantinople_vm_runtime_imports :
  AreImported globals "ethereum.constantinople.vm.runtime" [ "get_valid_jump_destinations" ].
