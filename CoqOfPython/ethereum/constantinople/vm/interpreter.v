...
Axiom ethereum_constantinople_state_account_has_code_or_nonce :
  IsGlobalAlias globals ethereum.constantinople.state.globals "account_has_code_or_nonce".
Axiom ethereum_constantinople_state_begin_transaction :
  IsGlobalAlias globals ethereum.constantinople.state.globals "begin_transaction".
Axiom ethereum_constantinople_state_commit_transaction :
  IsGlobalAlias globals ethereum.constantinople.state.globals "commit_transaction".
Axiom ethereum_constantinople_state_destroy_storage :
  IsGlobalAlias globals ethereum.constantinople.state.globals "destroy_storage".
...
Axiom ethereum_constantinople_state_move_ether :
  IsGlobalAlias globals ethereum.constantinople.state.globals "move_ether".
Axiom ethereum_constantinople_state_rollback_transaction :
  IsGlobalAlias globals ethereum.constantinople.state.globals "rollback_transaction".
Axiom ethereum_constantinople_state_set_code :
  IsGlobalAlias globals ethereum.constantinople.state.globals "set_code".
Axiom ethereum_constantinople_state_touch_account :
  IsGlobalAlias globals ethereum.constantinople.state.globals "touch_account".

Require ethereum.constantinople.vm.__init__.
Axiom ethereum_constantinople_vm___init___Message :
  IsGlobalAlias globals ethereum.constantinople.vm.__init__.globals "Message".

Require ethereum.constantinople.vm.gas.
Axiom ethereum_constantinople_vm_gas_GAS_CODE_DEPOSIT :
  IsGlobalAlias globals ethereum.constantinople.vm.gas.globals "GAS_CODE_DEPOSIT".
...
Axiom ethereum_constantinople_vm_precompiled_contracts_mapping_PRE_COMPILED_CONTRACTS :
  IsGlobalAlias globals ethereum.constantinople.vm.precompiled_contracts.mapping.globals "PRE_COMPILED_CONTRACTS".

Require ethereum.constantinople.vm.__init__.
Axiom ethereum_constantinople_vm___init___Environment :
  IsGlobalAlias globals ethereum.constantinople.vm.__init__.globals "Environment".
...
Axiom ethereum_constantinople_vm_exceptions_AddressCollision :
  IsGlobalAlias globals ethereum.constantinople.vm.exceptions.globals "AddressCollision".
Axiom ethereum_constantinople_vm_exceptions_ExceptionalHalt :
  IsGlobalAlias globals ethereum.constantinople.vm.exceptions.globals "ExceptionalHalt".
Axiom ethereum_constantinople_vm_exceptions_InvalidOpcode :
  IsGlobalAlias globals ethereum.constantinople.vm.exceptions.globals "InvalidOpcode".
Axiom ethereum_constantinople_vm_exceptions_OutOfGasError :
  IsGlobalAlias globals ethereum.constantinople.vm.exceptions.globals "OutOfGasError".
Axiom ethereum_constantinople_vm_exceptions_Revert :
  IsGlobalAlias globals ethereum.constantinople.vm.exceptions.globals "Revert".
Axiom ethereum_constantinople_vm_exceptions_StackDepthLimitError :
  IsGlobalAlias globals ethereum.constantinople.vm.exceptions.globals "StackDepthLimitError".

Require ethereum.constantinople.vm.instructions.__init__.
Axiom ethereum_constantinople_vm_instructions___init___Ops :
...
Axiom ethereum_constantinople_vm_instructions___init___op_implementation :
  IsGlobalAlias globals ethereum.constantinople.vm.instructions.__init__.globals "op_implementation".

Require ethereum.constantinople.vm.runtime.
Axiom ethereum_constantinople_vm_runtime_get_valid_jump_destinations :
  IsGlobalAlias globals ethereum.constantinople.vm.runtime.globals "get_valid_jump_destinations".
