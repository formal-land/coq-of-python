...
Definition globals : string := "ethereum.constantinople.vm.precompiled_contracts.ecrecover".
...
Axiom ethereum_constantinople_vm_gas_imports :
  AreImported globals "ethereum.constantinople.vm.gas" [ "GAS_ECRECOVER"; "charge_gas" ].
