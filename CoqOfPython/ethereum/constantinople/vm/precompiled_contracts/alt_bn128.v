...
Definition globals : string := "ethereum.constantinople.vm.precompiled_contracts.alt_bn128".
...
Axiom ethereum_constantinople_vm_exceptions_imports :
  AreImported globals "ethereum.constantinople.vm.exceptions" [ "OutOfGasError" ].
