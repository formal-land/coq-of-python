...
Definition globals : string := "ethereum.cancun.vm.instructions.log".
...
Axiom ethereum_cancun_vm_exceptions_imports :
  AreImported globals "ethereum.cancun.vm.exceptions" [ "WriteInStaticContext" ].

Axiom ethereum_cancun_vm_gas_imports :
  AreImported globals "ethereum.cancun.vm.gas" [ "GAS_LOG"; "GAS_LOG_DATA"; "GAS_LOG_TOPIC"; "calculate_gas_extend_memory"; "charge_gas" ].

Axiom ethereum_cancun_vm_memory_imports :
  AreImported globals "ethereum.cancun.vm.memory" [ "memory_read_bytes" ].

Axiom ethereum_cancun_vm_stack_imports :
  AreImported globals "ethereum.cancun.vm.stack" [ "pop" ].
