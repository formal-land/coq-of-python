...
Definition globals : string := "ethereum.cancun.vm.instructions.stack".
...
Axiom ethereum_cancun_vm_imports :
  AreImported globals "ethereum.cancun.vm" [ "Evm"; "stack" ].

Axiom ethereum_cancun_vm_exceptions_imports :
  AreImported globals "ethereum.cancun.vm.exceptions" [ "StackUnderflowError" ].

Axiom ethereum_cancun_vm_gas_imports :
  AreImported globals "ethereum.cancun.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "charge_gas" ].

Axiom ethereum_cancun_vm_memory_imports :
  AreImported globals "ethereum.cancun.vm.memory" [ "buffer_read" ].
