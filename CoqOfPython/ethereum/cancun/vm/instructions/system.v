...
Axiom gas_init_code_cost :
  IsGlobalAlias globals gas.globals "init_code_cost".
...
Definition generic_create : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    let _ := M.set_locals (| args, kwargs, [ "evm"; "endowment"; "contract_address"; "memory_start_position"; "memory_size"; "init_code_gas" ] |) in
    let _ := Constant.str "
  ...
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    ...
    make_list [
      ...
      BinOp.add (|
        ...
        |),
        M.get_name (| globals, "init_code_gas" |)
      |)
    ],
    make_dict []
  |) in
