...
Require ethereum.cancun.__init__.
Axiom ethereum_cancun___init___vm :
  IsGlobalAlias globals ethereum.cancun.__init__.globals "vm".

Require ethereum.cancun.blocks.
Axiom ethereum_cancun_blocks_Block :
  IsGlobalAlias globals ethereum.cancun.blocks.globals "Block".
...
Axiom ethereum_cancun_blocks_Receipt :
  IsGlobalAlias globals ethereum.cancun.blocks.globals "Receipt".
Axiom ethereum_cancun_blocks_Withdrawal :
  IsGlobalAlias globals ethereum.cancun.blocks.globals "Withdrawal".

Require ethereum.cancun.bloom.
Axiom ethereum_cancun_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.cancun.bloom.globals "logs_bloom".
...
Axiom ethereum_cancun_fork_types_VersionedHash :
  IsGlobalAlias globals ethereum.cancun.fork_types.globals "VersionedHash".

Require ethereum.cancun.state.
Axiom ethereum_cancun_state_State :
  IsGlobalAlias globals ethereum.cancun.state.globals "State".
Axiom ethereum_cancun_state_TransientStorage :
  IsGlobalAlias globals ethereum.cancun.state.globals "TransientStorage".
...
Axiom ethereum_cancun_state_destroy_account :
  IsGlobalAlias globals ethereum.cancun.state.globals "destroy_account".
Axiom ethereum_cancun_state_destroy_touched_empty_accounts :
  IsGlobalAlias globals ethereum.cancun.state.globals "destroy_touched_empty_accounts".
...
Axiom ethereum_cancun_state_process_withdrawal :
  IsGlobalAlias globals ethereum.cancun.state.globals "process_withdrawal".
Axiom ethereum_cancun_state_set_account_balance :
  IsGlobalAlias globals ethereum.cancun.state.globals "set_account_balance".
Axiom ethereum_cancun_state_state_root :
  IsGlobalAlias globals ethereum.cancun.state.globals "state_root".

Require ethereum.cancun.transactions.
Axiom ethereum_cancun_transactions_TX_ACCESS_LIST_ADDRESS_COST :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "TX_ACCESS_LIST_ADDRESS_COST".
Axiom ethereum_cancun_transactions_TX_ACCESS_LIST_STORAGE_KEY_COST :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "TX_ACCESS_LIST_STORAGE_KEY_COST".
Axiom ethereum_cancun_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "TX_BASE_COST".
Axiom ethereum_cancun_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "TX_CREATE_COST".
Axiom ethereum_cancun_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_cancun_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_cancun_transactions_AccessListTransaction :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "AccessListTransaction".
...
Axiom ethereum_cancun_transactions_FeeMarketTransaction :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "FeeMarketTransaction".
Axiom ethereum_cancun_transactions_LegacyTransaction :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "LegacyTransaction".
Axiom ethereum_cancun_transactions_Transaction :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "Transaction".
Axiom ethereum_cancun_transactions_decode_transaction :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "decode_transaction".
Axiom ethereum_cancun_transactions_encode_transaction :
  IsGlobalAlias globals ethereum.cancun.transactions.globals "encode_transaction".
...
Require ethereum.cancun.utils.hexadecimal.
Axiom ethereum_cancun_utils_hexadecimal_hex_to_address :
  IsGlobalAlias globals ethereum.cancun.utils.hexadecimal.globals "hex_to_address".

Require ethereum.cancun.utils.message.
Axiom ethereum_cancun_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.cancun.utils.message.globals "prepare_message".
...
Axiom ethereum_cancun_vm_gas_calculate_data_fee :
  IsGlobalAlias globals ethereum.cancun.vm.gas.globals "calculate_data_fee".
Axiom ethereum_cancun_vm_gas_calculate_excess_blob_gas :
  IsGlobalAlias globals ethereum.cancun.vm.gas.globals "calculate_excess_blob_gas".
Axiom ethereum_cancun_vm_gas_calculate_total_blob_gas :
  IsGlobalAlias globals ethereum.cancun.vm.gas.globals "calculate_total_blob_gas".
Axiom ethereum_cancun_vm_gas_init_code_cost :
  IsGlobalAlias globals ethereum.cancun.vm.gas.globals "init_code_cost".

Require ethereum.cancun.vm.interpreter.
Axiom ethereum_cancun_vm_interpreter_MAX_CODE_SIZE :
  IsGlobalAlias globals ethereum.cancun.vm.interpreter.globals "MAX_CODE_SIZE".
Axiom ethereum_cancun_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.cancun.vm.interpreter.globals "process_message_call".
...
Definition state_transition : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    ...
    make_list [
      Compare.eq (|
        M.get_field (| M.get_field (| M.get_name (| globals, "block" |), "header" |), "excess_blob_gas" |),
  ...
  |) in
    ...
    make_list [
      Compare.eq (|
        M.get_field (| M.get_name (| globals, "apply_body_output" |), "withdrawals_root" |),
        M.get_field (| M.get_field (| M.get_name (| globals, "block" |), "header" |), "withdrawals_root" |)
      |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
    ...
    make_list [
      Compare.eq (|
        M.get_field (| M.get_name (| globals, "apply_body_output" |), "blob_gas_used" |),
        M.get_field (| M.get_field (| M.get_name (| globals, "block" |), "header" |), "blob_gas_used" |)
      |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
      ...
      ltac:(M.monadic (
        ...
        For M.get_name (| globals, "blob_versioned_hash" |) in M.get_field (| M.get_name (| globals, "tx" |), "blob_versioned_hashes" |) do
          let _ :=
            ...
            M.if_then_else (|
              Compare.not_eq (|
                M.get_subscript (| M.get_name (| globals, "blob_versioned_hash" |), M.slice (| Constant.int 0, Constant.int 1 |) |),
                M.get_name (| globals, "VERSIONED_HASH_VERSION_KZG" |)
              |),
            (* then *)
            ltac:(M.monadic (
              let _ := M.raise (| Some(M.get_name (| globals, "InvalidBlock" |)) |) in
  ...
  |) in
    ...
    make_list [
      Compare.lt_e (|
        ...
        M.get_name (| globals, "MAX_BLOB_GAS_PER_BLOCK" |)
      |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
