...
Definition globals : string := "ethereum.london.fork".
...
Axiom ethereum_london_imports :
  AreImported globals "ethereum.london" [ "FORK_CRITERIA"; "vm" ].

Axiom ethereum_london_blocks_imports :
  AreImported globals "ethereum.london.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_london_bloom_imports :
  AreImported globals "ethereum.london.bloom" [ "logs_bloom" ].

Axiom ethereum_london_fork_types_imports :
  AreImported globals "ethereum.london.fork_types" [ "Address"; "Bloom"; "Root" ].

Axiom ethereum_london_state_imports :
  AreImported globals "ethereum.london.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_london_transactions_imports :
  AreImported globals "ethereum.london.transactions" [ "TX_ACCESS_LIST_ADDRESS_COST"; "TX_ACCESS_LIST_STORAGE_KEY_COST"; "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "AccessListTransaction"; "FeeMarketTransaction"; "LegacyTransaction"; "Transaction"; "decode_transaction"; "encode_transaction" ].

Axiom ethereum_london_trie_imports :
  AreImported globals "ethereum.london.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_london_utils_message_imports :
  AreImported globals "ethereum.london.utils.message" [ "prepare_message" ].

Axiom ethereum_london_vm_interpreter_imports :
  AreImported globals "ethereum.london.vm.interpreter" [ "process_message_call" ].
