...
Require ethereum.london.__init__.
Axiom ethereum_london___init___FORK_CRITERIA :
  IsGlobalAlias globals ethereum.london.__init__.globals "FORK_CRITERIA".
Axiom ethereum_london___init___vm :
  IsGlobalAlias globals ethereum.london.__init__.globals "vm".

Require ethereum.london.blocks.
Axiom ethereum_london_blocks_Block :
  IsGlobalAlias globals ethereum.london.blocks.globals "Block".
Axiom ethereum_london_blocks_Header :
  IsGlobalAlias globals ethereum.london.blocks.globals "Header".
Axiom ethereum_london_blocks_Log :
  IsGlobalAlias globals ethereum.london.blocks.globals "Log".
Axiom ethereum_london_blocks_Receipt :
  IsGlobalAlias globals ethereum.london.blocks.globals "Receipt".

Require ethereum.london.bloom.
Axiom ethereum_london_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.london.bloom.globals "logs_bloom".
...
Axiom ethereum_london_state_State :
  IsGlobalAlias globals ethereum.london.state.globals "State".
Axiom ethereum_london_state_account_exists_and_is_empty :
  IsGlobalAlias globals ethereum.london.state.globals "account_exists_and_is_empty".
Axiom ethereum_london_state_create_ether :
  IsGlobalAlias globals ethereum.london.state.globals "create_ether".
Axiom ethereum_london_state_destroy_account :
  IsGlobalAlias globals ethereum.london.state.globals "destroy_account".
Axiom ethereum_london_state_get_account :
  IsGlobalAlias globals ethereum.london.state.globals "get_account".
Axiom ethereum_london_state_increment_nonce :
  IsGlobalAlias globals ethereum.london.state.globals "increment_nonce".
Axiom ethereum_london_state_set_account_balance :
  IsGlobalAlias globals ethereum.london.state.globals "set_account_balance".
Axiom ethereum_london_state_state_root :
  IsGlobalAlias globals ethereum.london.state.globals "state_root".

Require ethereum.london.transactions.
Axiom ethereum_london_transactions_TX_ACCESS_LIST_ADDRESS_COST :
  IsGlobalAlias globals ethereum.london.transactions.globals "TX_ACCESS_LIST_ADDRESS_COST".
Axiom ethereum_london_transactions_TX_ACCESS_LIST_STORAGE_KEY_COST :
  IsGlobalAlias globals ethereum.london.transactions.globals "TX_ACCESS_LIST_STORAGE_KEY_COST".
Axiom ethereum_london_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.london.transactions.globals "TX_BASE_COST".
Axiom ethereum_london_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.london.transactions.globals "TX_CREATE_COST".
Axiom ethereum_london_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.london.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_london_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.london.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_london_transactions_AccessListTransaction :
  IsGlobalAlias globals ethereum.london.transactions.globals "AccessListTransaction".
Axiom ethereum_london_transactions_FeeMarketTransaction :
...
Axiom ethereum_london_transactions_Transaction :
  IsGlobalAlias globals ethereum.london.transactions.globals "Transaction".
Axiom ethereum_london_transactions_decode_transaction :
  IsGlobalAlias globals ethereum.london.transactions.globals "decode_transaction".
Axiom ethereum_london_transactions_encode_transaction :
  IsGlobalAlias globals ethereum.london.transactions.globals "encode_transaction".

Require ethereum.london.trie.
Axiom ethereum_london_trie_Trie :
  IsGlobalAlias globals ethereum.london.trie.globals "Trie".
Axiom ethereum_london_trie_root :
  IsGlobalAlias globals ethereum.london.trie.globals "root".
Axiom ethereum_london_trie_trie_set :
  IsGlobalAlias globals ethereum.london.trie.globals "trie_set".

Require ethereum.london.utils.message.
Axiom ethereum_london_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.london.utils.message.globals "prepare_message".

Require ethereum.london.vm.interpreter.
Axiom ethereum_london_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.london.vm.interpreter.globals "process_message_call".
...
Definition calculate_base_fee_per_gas : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    let _ := M.set_locals (| args, kwargs, [ "block_gas_limit"; "parent_gas_limit"; "parent_gas_used"; "parent_base_fee_per_gas"; "is_fork_block" ] |) in
    let _ := Constant.str "
    ...
    let _ :=
      (* if *)
      M.if_then_else (|
        M.get_name (| globals, "is_fork_block" |),
      (* then *)
      ltac:(M.monadic (
        let _ := M.return_ (|
          M.call (|
            M.get_name (| globals, "Uint" |),
            make_list [
              M.get_name (| globals, "INITIAL_BASE_FEE" |)
            ],
            make_dict []
          |)
        |) in
  ...
  |) in
    let is_fork_block :=
      Compare.eq (|
        ...
        M.get_field (| M.get_name (| globals, "FORK_CRITERIA" |), "block_number" |)
      |) in
    let expected_base_fee_per_gas :=
      M.call (|
