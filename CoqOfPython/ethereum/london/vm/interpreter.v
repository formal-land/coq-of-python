...
Axiom ethereum_london_state_account_has_code_or_nonce :
  IsGlobalAlias globals ethereum.london.state.globals "account_has_code_or_nonce".
Axiom ethereum_london_state_begin_transaction :
  IsGlobalAlias globals ethereum.london.state.globals "begin_transaction".
Axiom ethereum_london_state_commit_transaction :
  IsGlobalAlias globals ethereum.london.state.globals "commit_transaction".
Axiom ethereum_london_state_destroy_storage :
  IsGlobalAlias globals ethereum.london.state.globals "destroy_storage".
Axiom ethereum_london_state_increment_nonce :
  IsGlobalAlias globals ethereum.london.state.globals "increment_nonce".
Axiom ethereum_london_state_mark_account_created :
  IsGlobalAlias globals ethereum.london.state.globals "mark_account_created".
Axiom ethereum_london_state_move_ether :
  IsGlobalAlias globals ethereum.london.state.globals "move_ether".
Axiom ethereum_london_state_rollback_transaction :
  IsGlobalAlias globals ethereum.london.state.globals "rollback_transaction".
Axiom ethereum_london_state_set_code :
  IsGlobalAlias globals ethereum.london.state.globals "set_code".
Axiom ethereum_london_state_touch_account :
  IsGlobalAlias globals ethereum.london.state.globals "touch_account".

Require ethereum.london.vm.__init__.
Axiom ethereum_london_vm___init___Message :
  IsGlobalAlias globals ethereum.london.vm.__init__.globals "Message".

Require ethereum.london.vm.gas.
Axiom ethereum_london_vm_gas_GAS_CODE_DEPOSIT :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_CODE_DEPOSIT".
Axiom ethereum_london_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "charge_gas".

Require ethereum.london.vm.precompiled_contracts.mapping.
Axiom ethereum_london_vm_precompiled_contracts_mapping_PRE_COMPILED_CONTRACTS :
  IsGlobalAlias globals ethereum.london.vm.precompiled_contracts.mapping.globals "PRE_COMPILED_CONTRACTS".

Require ethereum.london.vm.__init__.
Axiom ethereum_london_vm___init___Environment :
  IsGlobalAlias globals ethereum.london.vm.__init__.globals "Environment".
...
Axiom ethereum_london_vm_exceptions_AddressCollision :
  IsGlobalAlias globals ethereum.london.vm.exceptions.globals "AddressCollision".
Axiom ethereum_london_vm_exceptions_ExceptionalHalt :
  IsGlobalAlias globals ethereum.london.vm.exceptions.globals "ExceptionalHalt".
Axiom ethereum_london_vm_exceptions_InvalidContractPrefix :
  IsGlobalAlias globals ethereum.london.vm.exceptions.globals "InvalidContractPrefix".
Axiom ethereum_london_vm_exceptions_InvalidOpcode :
  IsGlobalAlias globals ethereum.london.vm.exceptions.globals "InvalidOpcode".
...
Axiom ethereum_london_vm_exceptions_Revert :
  IsGlobalAlias globals ethereum.london.vm.exceptions.globals "Revert".
Axiom ethereum_london_vm_exceptions_StackDepthLimitError :
  IsGlobalAlias globals ethereum.london.vm.exceptions.globals "StackDepthLimitError".

Require ethereum.london.vm.instructions.__init__.
Axiom ethereum_london_vm_instructions___init___Ops :
  IsGlobalAlias globals ethereum.london.vm.instructions.__init__.globals "Ops".
Axiom ethereum_london_vm_instructions___init___op_implementation :
  IsGlobalAlias globals ethereum.london.vm.instructions.__init__.globals "op_implementation".

Require ethereum.london.vm.runtime.
Axiom ethereum_london_vm_runtime_get_valid_jump_destinations :
  IsGlobalAlias globals ethereum.london.vm.runtime.globals "get_valid_jump_destinations".
