...
Definition globals : string := "ethereum.london.vm.interpreter".
...
Axiom ethereum_london_state_imports :
  AreImported globals "ethereum.london.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "begin_transaction"; "commit_transaction"; "destroy_storage"; "increment_nonce"; "mark_account_created"; "move_ether"; "rollback_transaction"; "set_code"; "touch_account" ].

Axiom ethereum_london_vm_imports :
  AreImported globals "ethereum.london.vm" [ "Message" ].

Axiom ethereum_london_vm_gas_imports :
  AreImported globals "ethereum.london.vm.gas" [ "GAS_CODE_DEPOSIT"; "charge_gas" ].

Axiom ethereum_london_vm_precompiled_contracts_mapping_imports :
  AreImported globals "ethereum.london.vm.precompiled_contracts.mapping" [ "PRE_COMPILED_CONTRACTS" ].

Axiom ethereum_london_vm_imports :
  AreImported globals "ethereum.london.vm" [ "Environment"; "Evm" ].

Axiom ethereum_london_vm_exceptions_imports :
  AreImported globals "ethereum.london.vm.exceptions" [ "AddressCollision"; "ExceptionalHalt"; "InvalidContractPrefix"; "InvalidOpcode"; "OutOfGasError"; "Revert"; "StackDepthLimitError" ].

Axiom ethereum_london_vm_instructions_imports :
  AreImported globals "ethereum.london.vm.instructions" [ "Ops"; "op_implementation" ].

Axiom ethereum_london_vm_runtime_imports :
  AreImported globals "ethereum.london.vm.runtime" [ "get_valid_jump_destinations" ].
