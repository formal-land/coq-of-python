...
Definition globals : string := "ethereum.london.vm.precompiled_contracts.identity".
...
Axiom ethereum_london_vm_gas_imports :
  AreImported globals "ethereum.london.vm.gas" [ "GAS_IDENTITY"; "GAS_IDENTITY_WORD"; "charge_gas" ].
