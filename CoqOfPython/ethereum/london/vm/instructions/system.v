...
Axiom ethereum_london_state_is_account_alive :
  IsGlobalAlias globals ethereum.london.state.globals "is_account_alive".
...
Axiom ethereum_london_utils_address_compute_contract_address :
  IsGlobalAlias globals ethereum.london.utils.address.globals "compute_contract_address".
Axiom ethereum_london_utils_address_compute_create2_contract_address :
...
Axiom ethereum_london_utils_address_to_address :
  IsGlobalAlias globals ethereum.london.utils.address.globals "to_address".
...
Axiom ethereum_london_vm___init___incorporate_child_on_error :
  IsGlobalAlias globals ethereum.london.vm.__init__.globals "incorporate_child_on_error".
Axiom ethereum_london_vm___init___incorporate_child_on_success :
  IsGlobalAlias globals ethereum.london.vm.__init__.globals "incorporate_child_on_success".
...
Axiom ethereum_london_vm_gas_GAS_CALL_VALUE :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_CALL_VALUE".
Axiom ethereum_london_vm_gas_GAS_COLD_ACCOUNT_ACCESS :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_COLD_ACCOUNT_ACCESS".
Axiom ethereum_london_vm_gas_GAS_CREATE :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_CREATE".
Axiom ethereum_london_vm_gas_GAS_KECCAK256_WORD :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_KECCAK256_WORD".
Axiom ethereum_london_vm_gas_GAS_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_NEW_ACCOUNT".
Axiom ethereum_london_vm_gas_GAS_SELF_DESTRUCT :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_SELF_DESTRUCT".
Axiom ethereum_london_vm_gas_GAS_SELF_DESTRUCT_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_SELF_DESTRUCT_NEW_ACCOUNT".
Axiom ethereum_london_vm_gas_GAS_WARM_ACCESS :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_WARM_ACCESS".
Axiom ethereum_london_vm_gas_GAS_ZERO :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "GAS_ZERO".
...
Axiom ethereum_london_vm_gas_calculate_message_call_gas :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "calculate_message_call_gas".
Axiom ethereum_london_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "charge_gas".
Axiom ethereum_london_vm_gas_max_message_call_gas :
  IsGlobalAlias globals ethereum.london.vm.gas.globals "max_message_call_gas".
