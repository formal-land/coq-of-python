...
Definition globals : string := "ethereum.london.vm.instructions.environment".
...
Axiom ethereum_london_fork_types_imports :
  AreImported globals "ethereum.london.fork_types" [ "EMPTY_ACCOUNT" ].

Axiom ethereum_london_state_imports :
  AreImported globals "ethereum.london.state" [ "get_account" ].

Axiom ethereum_london_utils_address_imports :
  AreImported globals "ethereum.london.utils.address" [ "to_address" ].

Axiom ethereum_london_vm_memory_imports :
  AreImported globals "ethereum.london.vm.memory" [ "buffer_read"; "memory_write" ].

Axiom ethereum_london_vm_imports :
  AreImported globals "ethereum.london.vm" [ "Evm" ].

Axiom ethereum_london_vm_exceptions_imports :
  AreImported globals "ethereum.london.vm.exceptions" [ "OutOfBoundsRead" ].

Axiom ethereum_london_vm_gas_imports :
  AreImported globals "ethereum.london.vm.gas" [ "GAS_BASE"; "GAS_COLD_ACCOUNT_ACCESS"; "GAS_COPY"; "GAS_FAST_STEP"; "GAS_RETURN_DATA_COPY"; "GAS_VERY_LOW"; "GAS_WARM_ACCESS"; "calculate_gas_extend_memory"; "charge_gas" ].
