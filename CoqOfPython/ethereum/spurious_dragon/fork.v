...
Require ethereum.spurious_dragon.__init__.
Axiom ethereum_spurious_dragon___init___vm :
  IsGlobalAlias globals ethereum.spurious_dragon.__init__.globals "vm".

Require ethereum.spurious_dragon.blocks.
Axiom ethereum_spurious_dragon_blocks_Block :
  IsGlobalAlias globals ethereum.spurious_dragon.blocks.globals "Block".
Axiom ethereum_spurious_dragon_blocks_Header :
  IsGlobalAlias globals ethereum.spurious_dragon.blocks.globals "Header".
Axiom ethereum_spurious_dragon_blocks_Log :
  IsGlobalAlias globals ethereum.spurious_dragon.blocks.globals "Log".
Axiom ethereum_spurious_dragon_blocks_Receipt :
  IsGlobalAlias globals ethereum.spurious_dragon.blocks.globals "Receipt".

Require ethereum.spurious_dragon.bloom.
Axiom ethereum_spurious_dragon_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.spurious_dragon.bloom.globals "logs_bloom".
...
Axiom ethereum_spurious_dragon_state_State :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "State".
Axiom ethereum_spurious_dragon_state_account_exists_and_is_empty :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "account_exists_and_is_empty".
Axiom ethereum_spurious_dragon_state_create_ether :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "create_ether".
Axiom ethereum_spurious_dragon_state_destroy_account :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "destroy_account".
Axiom ethereum_spurious_dragon_state_get_account :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "get_account".
Axiom ethereum_spurious_dragon_state_increment_nonce :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "increment_nonce".
Axiom ethereum_spurious_dragon_state_set_account_balance :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "set_account_balance".
Axiom ethereum_spurious_dragon_state_state_root :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "state_root".

Require ethereum.spurious_dragon.transactions.
Axiom ethereum_spurious_dragon_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.spurious_dragon.transactions.globals "TX_BASE_COST".
Axiom ethereum_spurious_dragon_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.spurious_dragon.transactions.globals "TX_CREATE_COST".
Axiom ethereum_spurious_dragon_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.spurious_dragon.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_spurious_dragon_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.spurious_dragon.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_spurious_dragon_transactions_Transaction :
  IsGlobalAlias globals ethereum.spurious_dragon.transactions.globals "Transaction".

Require ethereum.spurious_dragon.trie.
Axiom ethereum_spurious_dragon_trie_Trie :
  IsGlobalAlias globals ethereum.spurious_dragon.trie.globals "Trie".
Axiom ethereum_spurious_dragon_trie_root :
  IsGlobalAlias globals ethereum.spurious_dragon.trie.globals "root".
Axiom ethereum_spurious_dragon_trie_trie_set :
  IsGlobalAlias globals ethereum.spurious_dragon.trie.globals "trie_set".

Require ethereum.spurious_dragon.utils.message.
Axiom ethereum_spurious_dragon_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.spurious_dragon.utils.message.globals "prepare_message".

Require ethereum.spurious_dragon.vm.interpreter.
Axiom ethereum_spurious_dragon_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.interpreter.globals "process_message_call".
...
Definition make_receipt : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    let _ := M.set_locals (| args, kwargs, [ "tx"; "post_state"; "cumulative_gas_used"; "logs" ] |) in
    let _ := Constant.str "
...
(* At stmt: unsupported node type: AnnAssign *)
  ...
  |) in
      ...
      let env :=
        ...
        |) in
      let _ := M.assign (|
        make_tuple [ M.get_name (| globals, "gas_used" |); M.get_name (| globals, "logs" |) ],
        M.call (|
...
Definition process_transaction : Value.t -> Value.t -> M :=
  ...
  |) in
    ...
    EndFor.
    let _ := M.return_ (|
      make_tuple [ M.get_name (| globals, "total_gas_used" |); M.get_field (| M.get_name (| globals, "output" |), "logs" |) ]
    |) in
    M.pure Constant.None_)).
...
Definition calculate_block_difficulty : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    let _ := M.set_locals (| args, kwargs, [ "block_number"; "block_timestamp"; "parent_timestamp"; "parent_difficulty" ] |) in
    let _ := Constant.str "
