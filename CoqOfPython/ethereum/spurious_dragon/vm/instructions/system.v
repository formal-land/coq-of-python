...
Axiom ethereum_spurious_dragon_state_is_account_alive :
  IsGlobalAlias globals ethereum.spurious_dragon.state.globals "is_account_alive".
...
Axiom ethereum_spurious_dragon_utils_address_compute_contract_address :
  IsGlobalAlias globals ethereum.spurious_dragon.utils.address.globals "compute_contract_address".
...
Axiom ethereum_spurious_dragon_vm___init___incorporate_child_on_error :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.__init__.globals "incorporate_child_on_error".
Axiom ethereum_spurious_dragon_vm___init___incorporate_child_on_success :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.__init__.globals "incorporate_child_on_success".

Require ethereum.spurious_dragon.vm.gas.
Axiom ethereum_spurious_dragon_vm_gas_GAS_CALL :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_CALL".
Axiom ethereum_spurious_dragon_vm_gas_GAS_CALL_VALUE :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_CALL_VALUE".
Axiom ethereum_spurious_dragon_vm_gas_GAS_CREATE :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_CREATE".
Axiom ethereum_spurious_dragon_vm_gas_GAS_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_NEW_ACCOUNT".
Axiom ethereum_spurious_dragon_vm_gas_GAS_SELF_DESTRUCT :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_SELF_DESTRUCT".
Axiom ethereum_spurious_dragon_vm_gas_GAS_SELF_DESTRUCT_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_SELF_DESTRUCT_NEW_ACCOUNT".
Axiom ethereum_spurious_dragon_vm_gas_GAS_ZERO :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "GAS_ZERO".
Axiom ethereum_spurious_dragon_vm_gas_REFUND_SELF_DESTRUCT :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "REFUND_SELF_DESTRUCT".
...
Axiom ethereum_spurious_dragon_vm_gas_calculate_message_call_gas :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "calculate_message_call_gas".
Axiom ethereum_spurious_dragon_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "charge_gas".
Axiom ethereum_spurious_dragon_vm_gas_max_message_call_gas :
  IsGlobalAlias globals ethereum.spurious_dragon.vm.gas.globals "max_message_call_gas".
