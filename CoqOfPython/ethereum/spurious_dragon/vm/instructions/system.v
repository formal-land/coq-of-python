...
Definition globals : string := "ethereum.spurious_dragon.vm.instructions.system".
...
Axiom ethereum_spurious_dragon_state_imports :
  AreImported globals "ethereum.spurious_dragon.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "get_account"; "increment_nonce"; "is_account_alive"; "set_account_balance" ].

Axiom ethereum_spurious_dragon_utils_address_imports :
  AreImported globals "ethereum.spurious_dragon.utils.address" [ "compute_contract_address"; "to_address" ].

Axiom ethereum_spurious_dragon_vm_imports :
  AreImported globals "ethereum.spurious_dragon.vm" [ "Evm"; "Message"; "incorporate_child_on_error"; "incorporate_child_on_success" ].

Axiom ethereum_spurious_dragon_vm_gas_imports :
  AreImported globals "ethereum.spurious_dragon.vm.gas" [ "GAS_CALL"; "GAS_CALL_VALUE"; "GAS_CREATE"; "GAS_NEW_ACCOUNT"; "GAS_SELF_DESTRUCT"; "GAS_SELF_DESTRUCT_NEW_ACCOUNT"; "GAS_ZERO"; "REFUND_SELF_DESTRUCT"; "calculate_gas_extend_memory"; "calculate_message_call_gas"; "charge_gas"; "max_message_call_gas" ].
