...
Definition globals : string := "ethereum.istanbul.vm.interpreter".
...
Axiom ethereum_istanbul_state_imports :
  AreImported globals "ethereum.istanbul.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "begin_transaction"; "commit_transaction"; "destroy_storage"; "increment_nonce"; "mark_account_created"; "move_ether"; "rollback_transaction"; "set_code"; "touch_account" ].

Axiom ethereum_istanbul_vm_imports :
  AreImported globals "ethereum.istanbul.vm" [ "Message" ].

Axiom ethereum_istanbul_vm_gas_imports :
  AreImported globals "ethereum.istanbul.vm.gas" [ "GAS_CODE_DEPOSIT"; "charge_gas" ].

Axiom ethereum_istanbul_vm_precompiled_contracts_mapping_imports :
  AreImported globals "ethereum.istanbul.vm.precompiled_contracts.mapping" [ "PRE_COMPILED_CONTRACTS" ].

Axiom ethereum_istanbul_vm_imports :
  AreImported globals "ethereum.istanbul.vm" [ "Environment"; "Evm" ].

Axiom ethereum_istanbul_vm_exceptions_imports :
  AreImported globals "ethereum.istanbul.vm.exceptions" [ "AddressCollision"; "ExceptionalHalt"; "InvalidOpcode"; "OutOfGasError"; "Revert"; "StackDepthLimitError" ].

Axiom ethereum_istanbul_vm_instructions_imports :
  AreImported globals "ethereum.istanbul.vm.instructions" [ "Ops"; "op_implementation" ].

Axiom ethereum_istanbul_vm_runtime_imports :
  AreImported globals "ethereum.istanbul.vm.runtime" [ "get_valid_jump_destinations" ].
