...
Axiom ethereum_istanbul_state_begin_transaction :
  IsGlobalAlias globals ethereum.istanbul.state.globals "begin_transaction".
Axiom ethereum_istanbul_state_commit_transaction :
  IsGlobalAlias globals ethereum.istanbul.state.globals "commit_transaction".
Axiom ethereum_istanbul_state_destroy_storage :
  IsGlobalAlias globals ethereum.istanbul.state.globals "destroy_storage".
Axiom ethereum_istanbul_state_increment_nonce :
  IsGlobalAlias globals ethereum.istanbul.state.globals "increment_nonce".
Axiom ethereum_istanbul_state_mark_account_created :
  IsGlobalAlias globals ethereum.istanbul.state.globals "mark_account_created".
Axiom ethereum_istanbul_state_move_ether :
  IsGlobalAlias globals ethereum.istanbul.state.globals "move_ether".
Axiom ethereum_istanbul_state_rollback_transaction :
  IsGlobalAlias globals ethereum.istanbul.state.globals "rollback_transaction".
Axiom ethereum_istanbul_state_set_code :
  IsGlobalAlias globals ethereum.istanbul.state.globals "set_code".
Axiom ethereum_istanbul_state_touch_account :
  IsGlobalAlias globals ethereum.istanbul.state.globals "touch_account".
...
Axiom ethereum_istanbul_vm_gas_GAS_CODE_DEPOSIT :
  IsGlobalAlias globals ethereum.istanbul.vm.gas.globals "GAS_CODE_DEPOSIT".
Axiom ethereum_istanbul_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.istanbul.vm.gas.globals "charge_gas".

Require ethereum.istanbul.vm.precompiled_contracts.mapping.
Axiom ethereum_istanbul_vm_precompiled_contracts_mapping_PRE_COMPILED_CONTRACTS :
  IsGlobalAlias globals ethereum.istanbul.vm.precompiled_contracts.mapping.globals "PRE_COMPILED_CONTRACTS".

Require ethereum.istanbul.vm.__init__.
Axiom ethereum_istanbul_vm___init___Environment :
  IsGlobalAlias globals ethereum.istanbul.vm.__init__.globals "Environment".
...
Axiom ethereum_istanbul_vm_exceptions_AddressCollision :
  IsGlobalAlias globals ethereum.istanbul.vm.exceptions.globals "AddressCollision".
Axiom ethereum_istanbul_vm_exceptions_ExceptionalHalt :
  IsGlobalAlias globals ethereum.istanbul.vm.exceptions.globals "ExceptionalHalt".
Axiom ethereum_istanbul_vm_exceptions_InvalidOpcode :
  IsGlobalAlias globals ethereum.istanbul.vm.exceptions.globals "InvalidOpcode".
...
Axiom ethereum_istanbul_vm_exceptions_StackDepthLimitError :
  IsGlobalAlias globals ethereum.istanbul.vm.exceptions.globals "StackDepthLimitError".
...
Require ethereum.istanbul.vm.runtime.
Axiom ethereum_istanbul_vm_runtime_get_valid_jump_destinations :
  IsGlobalAlias globals ethereum.istanbul.vm.runtime.globals "get_valid_jump_destinations".
