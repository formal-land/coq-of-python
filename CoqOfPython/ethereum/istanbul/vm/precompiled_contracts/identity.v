...
Definition globals : string := "ethereum.istanbul.vm.precompiled_contracts.identity".
...
Axiom ethereum_istanbul_vm_gas_imports :
  AreImported globals "ethereum.istanbul.vm.gas" [ "GAS_IDENTITY"; "GAS_IDENTITY_WORD"; "charge_gas" ].
