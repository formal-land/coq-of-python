...
Definition globals : string := "ethereum.istanbul.vm.instructions.environment".
...
Axiom ethereum_istanbul_fork_types_imports :
  AreImported globals "ethereum.istanbul.fork_types" [ "EMPTY_ACCOUNT" ].

Axiom ethereum_istanbul_state_imports :
  AreImported globals "ethereum.istanbul.state" [ "get_account" ].

Axiom ethereum_istanbul_utils_address_imports :
  AreImported globals "ethereum.istanbul.utils.address" [ "to_address" ].

Axiom ethereum_istanbul_vm_memory_imports :
  AreImported globals "ethereum.istanbul.vm.memory" [ "buffer_read"; "memory_write" ].
...
Axiom ethereum_istanbul_vm_exceptions_imports :
  AreImported globals "ethereum.istanbul.vm.exceptions" [ "OutOfBoundsRead" ].

Axiom ethereum_istanbul_vm_gas_imports :
  AreImported globals "ethereum.istanbul.vm.gas" [ "GAS_BALANCE"; "GAS_BASE"; "GAS_CODE_HASH"; "GAS_COPY"; "GAS_EXTERNAL"; "GAS_FAST_STEP"; "GAS_RETURN_DATA_COPY"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
