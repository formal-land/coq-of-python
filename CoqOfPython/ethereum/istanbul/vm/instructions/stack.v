...
Definition globals : string := "ethereum.istanbul.vm.instructions.stack".
...
Axiom ethereum_istanbul_vm_imports :
  AreImported globals "ethereum.istanbul.vm" [ "Evm"; "stack" ].

Axiom ethereum_istanbul_vm_exceptions_imports :
  AreImported globals "ethereum.istanbul.vm.exceptions" [ "StackUnderflowError" ].

Axiom ethereum_istanbul_vm_gas_imports :
  AreImported globals "ethereum.istanbul.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "charge_gas" ].

Axiom ethereum_istanbul_vm_memory_imports :
  AreImported globals "ethereum.istanbul.vm.memory" [ "buffer_read" ].
