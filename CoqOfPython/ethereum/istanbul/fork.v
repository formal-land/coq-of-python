...
Require ethereum.istanbul.__init__.
Axiom ethereum_istanbul___init___vm :
  IsGlobalAlias globals ethereum.istanbul.__init__.globals "vm".

Require ethereum.istanbul.blocks.
Axiom ethereum_istanbul_blocks_Block :
  IsGlobalAlias globals ethereum.istanbul.blocks.globals "Block".
Axiom ethereum_istanbul_blocks_Header :
  IsGlobalAlias globals ethereum.istanbul.blocks.globals "Header".
Axiom ethereum_istanbul_blocks_Log :
  IsGlobalAlias globals ethereum.istanbul.blocks.globals "Log".
Axiom ethereum_istanbul_blocks_Receipt :
  IsGlobalAlias globals ethereum.istanbul.blocks.globals "Receipt".

Require ethereum.istanbul.bloom.
Axiom ethereum_istanbul_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.istanbul.bloom.globals "logs_bloom".
...
Axiom ethereum_istanbul_fork_types_Bloom :
  IsGlobalAlias globals ethereum.istanbul.fork_types.globals "Bloom".
Axiom ethereum_istanbul_fork_types_Root :
  IsGlobalAlias globals ethereum.istanbul.fork_types.globals "Root".

Require ethereum.istanbul.state.
Axiom ethereum_istanbul_state_State :
  IsGlobalAlias globals ethereum.istanbul.state.globals "State".
...
Axiom ethereum_istanbul_state_create_ether :
  IsGlobalAlias globals ethereum.istanbul.state.globals "create_ether".
Axiom ethereum_istanbul_state_destroy_account :
  IsGlobalAlias globals ethereum.istanbul.state.globals "destroy_account".
...
Axiom ethereum_istanbul_state_state_root :
  IsGlobalAlias globals ethereum.istanbul.state.globals "state_root".

Require ethereum.istanbul.transactions.
Axiom ethereum_istanbul_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.istanbul.transactions.globals "TX_BASE_COST".
Axiom ethereum_istanbul_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.istanbul.transactions.globals "TX_CREATE_COST".
Axiom ethereum_istanbul_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.istanbul.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_istanbul_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.istanbul.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_istanbul_transactions_Transaction :
  IsGlobalAlias globals ethereum.istanbul.transactions.globals "Transaction".

Require ethereum.istanbul.trie.
Axiom ethereum_istanbul_trie_Trie :
  IsGlobalAlias globals ethereum.istanbul.trie.globals "Trie".
Axiom ethereum_istanbul_trie_root :
  IsGlobalAlias globals ethereum.istanbul.trie.globals "root".
Axiom ethereum_istanbul_trie_trie_set :
  IsGlobalAlias globals ethereum.istanbul.trie.globals "trie_set".

Require ethereum.istanbul.utils.message.
Axiom ethereum_istanbul_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.istanbul.utils.message.globals "prepare_message".

Require ethereum.istanbul.vm.interpreter.
Axiom ethereum_istanbul_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.istanbul.vm.interpreter.globals "process_message_call".
