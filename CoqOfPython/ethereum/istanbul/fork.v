...
Definition globals : string := "ethereum.istanbul.fork".
...
Axiom ethereum_istanbul_imports :
  AreImported globals "ethereum.istanbul" [ "vm" ].

Axiom ethereum_istanbul_blocks_imports :
  AreImported globals "ethereum.istanbul.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_istanbul_bloom_imports :
  AreImported globals "ethereum.istanbul.bloom" [ "logs_bloom" ].

Axiom ethereum_istanbul_fork_types_imports :
  AreImported globals "ethereum.istanbul.fork_types" [ "Address"; "Bloom"; "Root" ].

Axiom ethereum_istanbul_state_imports :
  AreImported globals "ethereum.istanbul.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_istanbul_transactions_imports :
  AreImported globals "ethereum.istanbul.transactions" [ "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "Transaction" ].

Axiom ethereum_istanbul_trie_imports :
  AreImported globals "ethereum.istanbul.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_istanbul_utils_message_imports :
  AreImported globals "ethereum.istanbul.utils.message" [ "prepare_message" ].

Axiom ethereum_istanbul_vm_interpreter_imports :
  AreImported globals "ethereum.istanbul.vm.interpreter" [ "process_message_call" ].
