...
Definition globals : string := "ethereum.muir_glacier.vm.instructions.block".
...
Axiom ethereum_muir_glacier_vm_gas_imports :
  AreImported globals "ethereum.muir_glacier.vm.gas" [ "GAS_BASE"; "GAS_BLOCK_HASH"; "charge_gas" ].
