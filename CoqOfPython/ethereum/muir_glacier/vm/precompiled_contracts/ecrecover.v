...
Definition globals : string := "ethereum.muir_glacier.vm.precompiled_contracts.ecrecover".
...
Axiom ethereum_muir_glacier_vm_gas_imports :
  AreImported globals "ethereum.muir_glacier.vm.gas" [ "GAS_ECRECOVER"; "charge_gas" ].
