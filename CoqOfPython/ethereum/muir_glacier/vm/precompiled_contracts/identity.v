...
Definition globals : string := "ethereum.muir_glacier.vm.precompiled_contracts.identity".
...
Axiom ethereum_muir_glacier_vm_gas_imports :
  AreImported globals "ethereum.muir_glacier.vm.gas" [ "GAS_IDENTITY"; "GAS_IDENTITY_WORD"; "charge_gas" ].
