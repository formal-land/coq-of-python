...
Definition globals : string := "ethereum.muir_glacier.fork".
...
Axiom ethereum_muir_glacier_imports :
  AreImported globals "ethereum.muir_glacier" [ "vm" ].

Axiom ethereum_muir_glacier_blocks_imports :
  AreImported globals "ethereum.muir_glacier.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_muir_glacier_bloom_imports :
  AreImported globals "ethereum.muir_glacier.bloom" [ "logs_bloom" ].

Axiom ethereum_muir_glacier_fork_types_imports :
  AreImported globals "ethereum.muir_glacier.fork_types" [ "Address"; "Bloom"; "Root" ].

Axiom ethereum_muir_glacier_state_imports :
  AreImported globals "ethereum.muir_glacier.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_muir_glacier_transactions_imports :
  AreImported globals "ethereum.muir_glacier.transactions" [ "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "Transaction" ].

Axiom ethereum_muir_glacier_trie_imports :
  AreImported globals "ethereum.muir_glacier.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_muir_glacier_utils_message_imports :
  AreImported globals "ethereum.muir_glacier.utils.message" [ "prepare_message" ].

Axiom ethereum_muir_glacier_vm_interpreter_imports :
  AreImported globals "ethereum.muir_glacier.vm.interpreter" [ "process_message_call" ].
