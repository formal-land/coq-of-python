...
Require ethereum.muir_glacier.__init__.
Axiom ethereum_muir_glacier___init___vm :
  IsGlobalAlias globals ethereum.muir_glacier.__init__.globals "vm".

Require ethereum.muir_glacier.blocks.
Axiom ethereum_muir_glacier_blocks_Block :
  IsGlobalAlias globals ethereum.muir_glacier.blocks.globals "Block".
Axiom ethereum_muir_glacier_blocks_Header :
  IsGlobalAlias globals ethereum.muir_glacier.blocks.globals "Header".
Axiom ethereum_muir_glacier_blocks_Log :
  IsGlobalAlias globals ethereum.muir_glacier.blocks.globals "Log".
Axiom ethereum_muir_glacier_blocks_Receipt :
  IsGlobalAlias globals ethereum.muir_glacier.blocks.globals "Receipt".

Require ethereum.muir_glacier.bloom.
Axiom ethereum_muir_glacier_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.muir_glacier.bloom.globals "logs_bloom".
...
Axiom ethereum_muir_glacier_fork_types_Root :
  IsGlobalAlias globals ethereum.muir_glacier.fork_types.globals "Root".

Require ethereum.muir_glacier.state.
Axiom ethereum_muir_glacier_state_State :
  IsGlobalAlias globals ethereum.muir_glacier.state.globals "State".
...
Axiom ethereum_muir_glacier_state_create_ether :
  IsGlobalAlias globals ethereum.muir_glacier.state.globals "create_ether".
Axiom ethereum_muir_glacier_state_destroy_account :
  IsGlobalAlias globals ethereum.muir_glacier.state.globals "destroy_account".
...
Axiom ethereum_muir_glacier_state_state_root :
  IsGlobalAlias globals ethereum.muir_glacier.state.globals "state_root".

Require ethereum.muir_glacier.transactions.
Axiom ethereum_muir_glacier_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.muir_glacier.transactions.globals "TX_BASE_COST".
Axiom ethereum_muir_glacier_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.muir_glacier.transactions.globals "TX_CREATE_COST".
Axiom ethereum_muir_glacier_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.muir_glacier.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_muir_glacier_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.muir_glacier.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_muir_glacier_transactions_Transaction :
  IsGlobalAlias globals ethereum.muir_glacier.transactions.globals "Transaction".

Require ethereum.muir_glacier.trie.
Axiom ethereum_muir_glacier_trie_Trie :
  IsGlobalAlias globals ethereum.muir_glacier.trie.globals "Trie".
Axiom ethereum_muir_glacier_trie_root :
  IsGlobalAlias globals ethereum.muir_glacier.trie.globals "root".
Axiom ethereum_muir_glacier_trie_trie_set :
  IsGlobalAlias globals ethereum.muir_glacier.trie.globals "trie_set".

Require ethereum.muir_glacier.utils.message.
Axiom ethereum_muir_glacier_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.muir_glacier.utils.message.globals "prepare_message".

Require ethereum.muir_glacier.vm.interpreter.
Axiom ethereum_muir_glacier_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.muir_glacier.vm.interpreter.globals "process_message_call".
