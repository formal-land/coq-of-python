...
Definition globals : string := "ethereum.frontier.vm.precompiled_contracts.identity".
...
Axiom ethereum_frontier_vm_gas_imports :
  AreImported globals "ethereum.frontier.vm.gas" [ "GAS_IDENTITY"; "GAS_IDENTITY_WORD"; "charge_gas" ].
