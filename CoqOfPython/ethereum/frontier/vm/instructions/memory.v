...
Definition globals : string := "ethereum.frontier.vm.instructions.memory".
...
Axiom ethereum_frontier_vm_gas_imports :
  AreImported globals "ethereum.frontier.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
