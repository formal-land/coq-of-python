...
Definition globals : string := "ethereum.frontier.fork".
...
Axiom ethereum_frontier_imports :
  AreImported globals "ethereum.frontier" [ "vm" ].

Axiom ethereum_frontier_blocks_imports :
  AreImported globals "ethereum.frontier.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_frontier_bloom_imports :
  AreImported globals "ethereum.frontier.bloom" [ "logs_bloom" ].

Axiom ethereum_frontier_fork_types_imports :
  AreImported globals "ethereum.frontier.fork_types" [ "Address"; "Bloom"; "Root" ].

Axiom ethereum_frontier_state_imports :
  AreImported globals "ethereum.frontier.state" [ "State"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_frontier_transactions_imports :
  AreImported globals "ethereum.frontier.transactions" [ "TX_BASE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "Transaction" ].

Axiom ethereum_frontier_trie_imports :
  AreImported globals "ethereum.frontier.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_frontier_utils_message_imports :
  AreImported globals "ethereum.frontier.utils.message" [ "prepare_message" ].

Axiom ethereum_frontier_vm_interpreter_imports :
  AreImported globals "ethereum.frontier.vm.interpreter" [ "process_message_call" ].
