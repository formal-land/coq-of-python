...
Require ethereum.frontier.__init__.
Axiom ethereum_frontier___init___vm :
  IsGlobalAlias globals ethereum.frontier.__init__.globals "vm".

Require ethereum.frontier.blocks.
Axiom ethereum_frontier_blocks_Block :
  IsGlobalAlias globals ethereum.frontier.blocks.globals "Block".
Axiom ethereum_frontier_blocks_Header :
  IsGlobalAlias globals ethereum.frontier.blocks.globals "Header".
Axiom ethereum_frontier_blocks_Log :
  IsGlobalAlias globals ethereum.frontier.blocks.globals "Log".
Axiom ethereum_frontier_blocks_Receipt :
  IsGlobalAlias globals ethereum.frontier.blocks.globals "Receipt".

Require ethereum.frontier.bloom.
Axiom ethereum_frontier_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.frontier.bloom.globals "logs_bloom".
...
Axiom ethereum_frontier_fork_types_Bloom :
  IsGlobalAlias globals ethereum.frontier.fork_types.globals "Bloom".
Axiom ethereum_frontier_fork_types_Root :
  IsGlobalAlias globals ethereum.frontier.fork_types.globals "Root".

Require ethereum.frontier.state.
Axiom ethereum_frontier_state_State :
  IsGlobalAlias globals ethereum.frontier.state.globals "State".
Axiom ethereum_frontier_state_create_ether :
  IsGlobalAlias globals ethereum.frontier.state.globals "create_ether".
Axiom ethereum_frontier_state_destroy_account :
  IsGlobalAlias globals ethereum.frontier.state.globals "destroy_account".
Axiom ethereum_frontier_state_get_account :
  IsGlobalAlias globals ethereum.frontier.state.globals "get_account".
Axiom ethereum_frontier_state_increment_nonce :
  IsGlobalAlias globals ethereum.frontier.state.globals "increment_nonce".
Axiom ethereum_frontier_state_set_account_balance :
  IsGlobalAlias globals ethereum.frontier.state.globals "set_account_balance".
Axiom ethereum_frontier_state_state_root :
  IsGlobalAlias globals ethereum.frontier.state.globals "state_root".

Require ethereum.frontier.transactions.
Axiom ethereum_frontier_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.frontier.transactions.globals "TX_BASE_COST".
Axiom ethereum_frontier_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.frontier.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_frontier_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.frontier.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_frontier_transactions_Transaction :
  IsGlobalAlias globals ethereum.frontier.transactions.globals "Transaction".

Require ethereum.frontier.trie.
Axiom ethereum_frontier_trie_Trie :
  IsGlobalAlias globals ethereum.frontier.trie.globals "Trie".
Axiom ethereum_frontier_trie_root :
  IsGlobalAlias globals ethereum.frontier.trie.globals "root".
Axiom ethereum_frontier_trie_trie_set :
  IsGlobalAlias globals ethereum.frontier.trie.globals "trie_set".

Require ethereum.frontier.utils.message.
Axiom ethereum_frontier_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.frontier.utils.message.globals "prepare_message".

Require ethereum.frontier.vm.interpreter.
Axiom ethereum_frontier_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.frontier.vm.interpreter.globals "process_message_call".
