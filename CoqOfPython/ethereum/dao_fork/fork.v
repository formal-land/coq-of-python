...
Axiom base_types_U256_CEIL_VALUE :
  IsGlobalAlias globals base_types.globals "U256_CEIL_VALUE".
...
Require __init__.
Axiom __init___FORK_CRITERIA :
  IsGlobalAlias globals __init__.globals "FORK_CRITERIA".
Axiom __init___vm :
...
Require dao.
Axiom dao_apply_dao :
  IsGlobalAlias globals dao.globals "apply_dao".
...
Axiom state_create_ether :
  IsGlobalAlias globals state.globals "create_ether".
...
Definition validate_header : Value.t -> Value.t -> M :=
  ...
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.eq (| M.get_field (| M.get_name (| globals, "header" |), "difficulty" |), M.get_name (| globals, "block_difficulty" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
  ...
  |) in
    let _ :=
      ...
      M.if_then_else (|
        BoolOp.and (|
          Compare.gt_e (| M.get_field (| M.get_name (| globals, "header" |), "number" |), M.get_field (| M.get_name (| globals, "FORK_CRITERIA" |), "block_number" |) |),
          ltac:(M.monadic (
            Compare.lt (| M.get_field (| M.get_name (| globals, "header" |), "number" |), BinOp.add (|
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.eq (| M.get_field (| M.get_name (| globals, "header" |), "extra_data" |), (* At constant: unsupported node type: Constant *) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
...
Definition check_transaction : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.lt_e (| M.get_field (| M.get_name (| globals, "tx" |), "gas" |), M.get_name (| globals, "gas_available" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
...
Definition validate_ommers : Value.t -> Value.t -> M :=
  ...
  |) in
    let ommers_hashes :=
      [M.call (|
        ...
        make_dict []
      |) for (* At expr: unsupported node type: list *)] in
    let _ := M.call (|
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.eq (| M.call (|
  ...
  |) in
    let recent_canonical_blocks :=
      M.get_subscript (| M.get_field (| M.get_name (| globals, "chain" |), "blocks" |), UnOp.sub (| BinOp.add (|
...
(* At stmt: unsupported node type: AnnAssign *)
  ...
  |) do
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.not_eq (| M.get_name (| globals, "ommer_hash" |), M.get_name (| globals, "block_hash" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.not_in (| M.get_name (| globals, "ommer_hash" |), M.get_name (| globals, "recent_canonical_block_hashes" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.not_in (| M.get_name (| globals, "ommer_hash" |), M.get_name (| globals, "recent_ommers_hashes" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
  ...
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.in (| M.get_field (| M.get_name (| globals, "ommer" |), "parent_hash" |), M.get_name (| globals, "recent_canonical_block_hashes" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.not_eq (| M.get_field (| M.get_name (| globals, "ommer" |), "parent_hash" |), M.get_field (| M.get_name (| globals, "block_header" |), "parent_hash" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
  ...
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    ...
    let _ := M.return_ (|
      BoolOp.and (|
        ...
        |), M.get_field (| M.get_name (| globals, "tx" |), "gas" |) |),
        ltac:(M.monadic (
          Compare.lt (| M.get_field (| M.get_name (| globals, "tx" |), "nonce" |), BinOp.sub (|
              BinOp.pow (|
                Constant.int 2,
                Constant.int 64
              |),
...
Definition calculate_block_difficulty : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    ...
    let _ :=
      (* if *)
      M.if_then_else (|
        Compare.gt_e (| M.get_name (| globals, "num_bomb_periods" |), Constant.int 0 |),
      (* then *)
      ltac:(M.monadic (
