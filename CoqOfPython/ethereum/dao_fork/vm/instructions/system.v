...
Definition globals : string := "ethereum.dao_fork.vm.instructions.system".
...
Axiom ethereum_dao_fork_state_imports :
  AreImported globals "ethereum.dao_fork.state" [ "account_has_code_or_nonce"; "get_account"; "increment_nonce"; "set_account_balance" ].

Axiom ethereum_dao_fork_utils_address_imports :
  AreImported globals "ethereum.dao_fork.utils.address" [ "compute_contract_address"; "to_address" ].

Axiom ethereum_dao_fork_vm_imports :
  AreImported globals "ethereum.dao_fork.vm" [ "Evm"; "Message"; "incorporate_child_on_error"; "incorporate_child_on_success" ].

Axiom ethereum_dao_fork_vm_gas_imports :
  AreImported globals "ethereum.dao_fork.vm.gas" [ "GAS_CALL"; "GAS_CREATE"; "GAS_ZERO"; "REFUND_SELF_DESTRUCT"; "calculate_gas_extend_memory"; "calculate_message_call_gas"; "charge_gas" ].

Axiom ethereum_dao_fork_vm_memory_imports :
  AreImported globals "ethereum.dao_fork.vm.memory" [ "memory_read_bytes"; "memory_write" ].
