...
Definition globals : string := "ethereum.dao_fork.vm.instructions.memory".
...
Axiom ethereum_dao_fork_vm_gas_imports :
  AreImported globals "ethereum.dao_fork.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
