...
Definition globals : string := "ethereum.gray_glacier.vm.precompiled_contracts.identity".
...
Axiom ethereum_gray_glacier_vm_gas_imports :
  AreImported globals "ethereum.gray_glacier.vm.gas" [ "GAS_IDENTITY"; "GAS_IDENTITY_WORD"; "charge_gas" ].
