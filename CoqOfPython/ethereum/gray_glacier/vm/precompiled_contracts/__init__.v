...
Definition globals : string := "ethereum.gray_glacier.vm.precompiled_contracts.__init__".
...
Axiom ethereum_gray_glacier_utils_hexadecimal_imports :
  AreImported globals "ethereum.gray_glacier.utils.hexadecimal" [ "hex_to_address" ].
