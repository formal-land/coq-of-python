...
Axiom ethereum_gray_glacier_state_is_account_alive :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "is_account_alive".
...
Axiom ethereum_gray_glacier_utils_address_compute_create2_contract_address :
  IsGlobalAlias globals ethereum.gray_glacier.utils.address.globals "compute_create2_contract_address".
...
Axiom ethereum_gray_glacier_vm___init___incorporate_child_on_error :
  IsGlobalAlias globals ethereum.gray_glacier.vm.__init__.globals "incorporate_child_on_error".
Axiom ethereum_gray_glacier_vm___init___incorporate_child_on_success :
  IsGlobalAlias globals ethereum.gray_glacier.vm.__init__.globals "incorporate_child_on_success".
...
Axiom ethereum_gray_glacier_vm_exceptions_WriteInStaticContext :
  IsGlobalAlias globals ethereum.gray_glacier.vm.exceptions.globals "WriteInStaticContext".

Require ethereum.gray_glacier.vm.gas.
Axiom ethereum_gray_glacier_vm_gas_GAS_CALL_VALUE :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_CALL_VALUE".
...
Axiom ethereum_gray_glacier_vm_gas_GAS_CREATE :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_CREATE".
Axiom ethereum_gray_glacier_vm_gas_GAS_KECCAK256_WORD :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_KECCAK256_WORD".
Axiom ethereum_gray_glacier_vm_gas_GAS_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_NEW_ACCOUNT".
Axiom ethereum_gray_glacier_vm_gas_GAS_SELF_DESTRUCT :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_SELF_DESTRUCT".
Axiom ethereum_gray_glacier_vm_gas_GAS_SELF_DESTRUCT_NEW_ACCOUNT :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_SELF_DESTRUCT_NEW_ACCOUNT".
...
Axiom ethereum_gray_glacier_vm_gas_GAS_ZERO :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "GAS_ZERO".
...
Axiom ethereum_gray_glacier_vm_gas_calculate_message_call_gas :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "calculate_message_call_gas".
Axiom ethereum_gray_glacier_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "charge_gas".
Axiom ethereum_gray_glacier_vm_gas_max_message_call_gas :
  IsGlobalAlias globals ethereum.gray_glacier.vm.gas.globals "max_message_call_gas".

Require ethereum.gray_glacier.vm.memory.
Axiom ethereum_gray_glacier_vm_memory_memory_read_bytes :
  IsGlobalAlias globals ethereum.gray_glacier.vm.memory.globals "memory_read_bytes".
