...
Definition globals : string := "ethereum.gray_glacier.vm.stack".
...
Axiom ethereum_gray_glacier_vm_exceptions_imports :
  AreImported globals "ethereum.gray_glacier.vm.exceptions" [ "StackOverflowError"; "StackUnderflowError" ].
