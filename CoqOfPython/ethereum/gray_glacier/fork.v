...
Require ethereum.gray_glacier.__init__.
Axiom ethereum_gray_glacier___init___vm :
  IsGlobalAlias globals ethereum.gray_glacier.__init__.globals "vm".

Require ethereum.gray_glacier.blocks.
Axiom ethereum_gray_glacier_blocks_Block :
  IsGlobalAlias globals ethereum.gray_glacier.blocks.globals "Block".
Axiom ethereum_gray_glacier_blocks_Header :
  IsGlobalAlias globals ethereum.gray_glacier.blocks.globals "Header".
Axiom ethereum_gray_glacier_blocks_Log :
  IsGlobalAlias globals ethereum.gray_glacier.blocks.globals "Log".
Axiom ethereum_gray_glacier_blocks_Receipt :
  IsGlobalAlias globals ethereum.gray_glacier.blocks.globals "Receipt".

Require ethereum.gray_glacier.bloom.
Axiom ethereum_gray_glacier_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.gray_glacier.bloom.globals "logs_bloom".
...
Axiom ethereum_gray_glacier_state_State :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "State".
Axiom ethereum_gray_glacier_state_account_exists_and_is_empty :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "account_exists_and_is_empty".
Axiom ethereum_gray_glacier_state_create_ether :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "create_ether".
Axiom ethereum_gray_glacier_state_destroy_account :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "destroy_account".
Axiom ethereum_gray_glacier_state_get_account :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "get_account".
Axiom ethereum_gray_glacier_state_increment_nonce :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "increment_nonce".
Axiom ethereum_gray_glacier_state_set_account_balance :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "set_account_balance".
Axiom ethereum_gray_glacier_state_state_root :
  IsGlobalAlias globals ethereum.gray_glacier.state.globals "state_root".

Require ethereum.gray_glacier.transactions.
Axiom ethereum_gray_glacier_transactions_TX_ACCESS_LIST_ADDRESS_COST :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "TX_ACCESS_LIST_ADDRESS_COST".
Axiom ethereum_gray_glacier_transactions_TX_ACCESS_LIST_STORAGE_KEY_COST :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "TX_ACCESS_LIST_STORAGE_KEY_COST".
Axiom ethereum_gray_glacier_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "TX_BASE_COST".
Axiom ethereum_gray_glacier_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "TX_CREATE_COST".
Axiom ethereum_gray_glacier_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_gray_glacier_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_gray_glacier_transactions_AccessListTransaction :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "AccessListTransaction".
Axiom ethereum_gray_glacier_transactions_FeeMarketTransaction :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "FeeMarketTransaction".
...
Axiom ethereum_gray_glacier_transactions_Transaction :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "Transaction".
Axiom ethereum_gray_glacier_transactions_decode_transaction :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "decode_transaction".
Axiom ethereum_gray_glacier_transactions_encode_transaction :
  IsGlobalAlias globals ethereum.gray_glacier.transactions.globals "encode_transaction".

Require ethereum.gray_glacier.trie.
Axiom ethereum_gray_glacier_trie_Trie :
  IsGlobalAlias globals ethereum.gray_glacier.trie.globals "Trie".
Axiom ethereum_gray_glacier_trie_root :
  IsGlobalAlias globals ethereum.gray_glacier.trie.globals "root".
Axiom ethereum_gray_glacier_trie_trie_set :
  IsGlobalAlias globals ethereum.gray_glacier.trie.globals "trie_set".

Require ethereum.gray_glacier.utils.message.
Axiom ethereum_gray_glacier_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.gray_glacier.utils.message.globals "prepare_message".

Require ethereum.gray_glacier.vm.interpreter.
Axiom ethereum_gray_glacier_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.gray_glacier.vm.interpreter.globals "process_message_call".
...
Definition apply_body : Value.t -> Value.t -> M :=
  fun (args kwargs : Value.t) => ltac:(M.monadic (
    let _ := M.set_locals (| args, kwargs, [ "state"; "block_hashes"; "coinbase"; "block_number"; "base_fee_per_gas"; "block_gas_limit"; "block_time"; "block_difficulty"; "transactions"; "ommers"; "chain_id" ] |) in
    let _ := Constant.str "
    Executes a block.
