...
Definition globals : string := "ethereum.gray_glacier.fork".
...
Axiom ethereum_gray_glacier_imports :
  AreImported globals "ethereum.gray_glacier" [ "vm" ].

Axiom ethereum_gray_glacier_blocks_imports :
  AreImported globals "ethereum.gray_glacier.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_gray_glacier_bloom_imports :
  AreImported globals "ethereum.gray_glacier.bloom" [ "logs_bloom" ].
...
Axiom ethereum_gray_glacier_state_imports :
  AreImported globals "ethereum.gray_glacier.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_gray_glacier_transactions_imports :
  AreImported globals "ethereum.gray_glacier.transactions" [ "TX_ACCESS_LIST_ADDRESS_COST"; "TX_ACCESS_LIST_STORAGE_KEY_COST"; "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "AccessListTransaction"; "FeeMarketTransaction"; "LegacyTransaction"; "Transaction"; "decode_transaction"; "encode_transaction" ].

Axiom ethereum_gray_glacier_trie_imports :
  AreImported globals "ethereum.gray_glacier.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_gray_glacier_utils_message_imports :
  AreImported globals "ethereum.gray_glacier.utils.message" [ "prepare_message" ].

Axiom ethereum_gray_glacier_vm_interpreter_imports :
  AreImported globals "ethereum.gray_glacier.vm.interpreter" [ "process_message_call" ].
