...
Require ethereum.arrow_glacier.
Axiom ethereum_arrow_glacier_trie :
  IsGlobalAlias globals ethereum.arrow_glacier.globals "trie".
        ...
        let _ :=
          ...
          M.if_then_else (|
            M.call (|
              ...
              make_list [
                M.get_name (| globals, "node" |);
                make_tuple [ M.get_name (| globals, "LegacyTransaction" |); M.get_name (| globals, "Receipt" |); M.get_name (| globals, "U256" |) ]
              ],
              make_dict []
            |),
          (* then *)
