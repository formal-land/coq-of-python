...
Definition globals : string := "ethereum.arrow_glacier.vm.instructions.stack".
...
Axiom ethereum_arrow_glacier_vm_imports :
  AreImported globals "ethereum.arrow_glacier.vm" [ "Evm"; "stack" ].

Axiom ethereum_arrow_glacier_vm_exceptions_imports :
  AreImported globals "ethereum.arrow_glacier.vm.exceptions" [ "StackUnderflowError" ].

Axiom ethereum_arrow_glacier_vm_gas_imports :
  AreImported globals "ethereum.arrow_glacier.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "charge_gas" ].

Axiom ethereum_arrow_glacier_vm_memory_imports :
  AreImported globals "ethereum.arrow_glacier.vm.memory" [ "buffer_read" ].
