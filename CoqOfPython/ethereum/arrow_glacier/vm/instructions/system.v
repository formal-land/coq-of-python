...
Definition globals : string := "ethereum.arrow_glacier.vm.instructions.system".
...
Axiom ethereum_arrow_glacier_state_imports :
  AreImported globals "ethereum.arrow_glacier.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "get_account"; "increment_nonce"; "is_account_alive"; "set_account_balance" ].

Axiom ethereum_arrow_glacier_utils_address_imports :
  AreImported globals "ethereum.arrow_glacier.utils.address" [ "compute_contract_address"; "compute_create2_contract_address"; "to_address" ].

Axiom ethereum_arrow_glacier_vm_imports :
  AreImported globals "ethereum.arrow_glacier.vm" [ "Evm"; "Message"; "incorporate_child_on_error"; "incorporate_child_on_success" ].

Axiom ethereum_arrow_glacier_vm_exceptions_imports :
  AreImported globals "ethereum.arrow_glacier.vm.exceptions" [ "Revert"; "WriteInStaticContext" ].

Axiom ethereum_arrow_glacier_vm_gas_imports :
  AreImported globals "ethereum.arrow_glacier.vm.gas" [ "GAS_CALL_VALUE"; "GAS_COLD_ACCOUNT_ACCESS"; "GAS_CREATE"; "GAS_KECCAK256_WORD"; "GAS_NEW_ACCOUNT"; "GAS_SELF_DESTRUCT"; "GAS_SELF_DESTRUCT_NEW_ACCOUNT"; "GAS_WARM_ACCESS"; "GAS_ZERO"; "calculate_gas_extend_memory"; "calculate_message_call_gas"; "charge_gas"; "max_message_call_gas" ].

Axiom ethereum_arrow_glacier_vm_memory_imports :
  AreImported globals "ethereum.arrow_glacier.vm.memory" [ "memory_read_bytes"; "memory_write" ].
