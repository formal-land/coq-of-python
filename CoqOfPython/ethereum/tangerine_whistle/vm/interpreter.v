...
Definition globals : string := "ethereum.tangerine_whistle.vm.interpreter".
...
Axiom ethereum_tangerine_whistle_state_imports :
  AreImported globals "ethereum.tangerine_whistle.state" [ "account_has_code_or_nonce"; "begin_transaction"; "commit_transaction"; "destroy_storage"; "move_ether"; "rollback_transaction"; "set_code"; "touch_account" ].

Axiom ethereum_tangerine_whistle_vm_imports :
  AreImported globals "ethereum.tangerine_whistle.vm" [ "Message" ].

Axiom ethereum_tangerine_whistle_vm_gas_imports :
  AreImported globals "ethereum.tangerine_whistle.vm.gas" [ "GAS_CODE_DEPOSIT"; "charge_gas" ].

Axiom ethereum_tangerine_whistle_vm_precompiled_contracts_mapping_imports :
  AreImported globals "ethereum.tangerine_whistle.vm.precompiled_contracts.mapping" [ "PRE_COMPILED_CONTRACTS" ].

Axiom ethereum_tangerine_whistle_vm_imports :
  AreImported globals "ethereum.tangerine_whistle.vm" [ "Environment"; "Evm" ].

Axiom ethereum_tangerine_whistle_vm_exceptions_imports :
  AreImported globals "ethereum.tangerine_whistle.vm.exceptions" [ "AddressCollision"; "ExceptionalHalt"; "InvalidOpcode"; "StackDepthLimitError" ].

Axiom ethereum_tangerine_whistle_vm_instructions_imports :
  AreImported globals "ethereum.tangerine_whistle.vm.instructions" [ "Ops"; "op_implementation" ].

Axiom ethereum_tangerine_whistle_vm_runtime_imports :
  AreImported globals "ethereum.tangerine_whistle.vm.runtime" [ "get_valid_jump_destinations" ].
