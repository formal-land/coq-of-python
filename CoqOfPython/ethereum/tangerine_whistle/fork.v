...
Require ethereum.tangerine_whistle.__init__.
Axiom ethereum_tangerine_whistle___init___vm :
  IsGlobalAlias globals ethereum.tangerine_whistle.__init__.globals "vm".

Require ethereum.tangerine_whistle.blocks.
Axiom ethereum_tangerine_whistle_blocks_Block :
  IsGlobalAlias globals ethereum.tangerine_whistle.blocks.globals "Block".
Axiom ethereum_tangerine_whistle_blocks_Header :
  IsGlobalAlias globals ethereum.tangerine_whistle.blocks.globals "Header".
Axiom ethereum_tangerine_whistle_blocks_Log :
  IsGlobalAlias globals ethereum.tangerine_whistle.blocks.globals "Log".
Axiom ethereum_tangerine_whistle_blocks_Receipt :
  IsGlobalAlias globals ethereum.tangerine_whistle.blocks.globals "Receipt".

Require ethereum.tangerine_whistle.bloom.
Axiom ethereum_tangerine_whistle_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.tangerine_whistle.bloom.globals "logs_bloom".
...
Axiom ethereum_tangerine_whistle_state_create_ether :
  IsGlobalAlias globals ethereum.tangerine_whistle.state.globals "create_ether".
Axiom ethereum_tangerine_whistle_state_destroy_account :
  IsGlobalAlias globals ethereum.tangerine_whistle.state.globals "destroy_account".
...
Axiom ethereum_tangerine_whistle_state_increment_nonce :
  IsGlobalAlias globals ethereum.tangerine_whistle.state.globals "increment_nonce".
Axiom ethereum_tangerine_whistle_state_set_account_balance :
  IsGlobalAlias globals ethereum.tangerine_whistle.state.globals "set_account_balance".
Axiom ethereum_tangerine_whistle_state_state_root :
  IsGlobalAlias globals ethereum.tangerine_whistle.state.globals "state_root".

Require ethereum.tangerine_whistle.transactions.
Axiom ethereum_tangerine_whistle_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.tangerine_whistle.transactions.globals "TX_BASE_COST".
Axiom ethereum_tangerine_whistle_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.tangerine_whistle.transactions.globals "TX_CREATE_COST".
Axiom ethereum_tangerine_whistle_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.tangerine_whistle.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_tangerine_whistle_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.tangerine_whistle.transactions.globals "TX_DATA_COST_PER_ZERO".
...
Require ethereum.tangerine_whistle.trie.
Axiom ethereum_tangerine_whistle_trie_Trie :
  IsGlobalAlias globals ethereum.tangerine_whistle.trie.globals "Trie".
Axiom ethereum_tangerine_whistle_trie_root :
  IsGlobalAlias globals ethereum.tangerine_whistle.trie.globals "root".
Axiom ethereum_tangerine_whistle_trie_trie_set :
  IsGlobalAlias globals ethereum.tangerine_whistle.trie.globals "trie_set".

Require ethereum.tangerine_whistle.utils.message.
Axiom ethereum_tangerine_whistle_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.tangerine_whistle.utils.message.globals "prepare_message".

Require ethereum.tangerine_whistle.vm.interpreter.
Axiom ethereum_tangerine_whistle_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.tangerine_whistle.vm.interpreter.globals "process_message_call".
