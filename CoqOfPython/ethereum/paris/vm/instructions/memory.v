...
Definition globals : string := "ethereum.paris.vm.instructions.memory".
...
Axiom ethereum_paris_vm_gas_imports :
  AreImported globals "ethereum.paris.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
