...
Definition globals : string := "ethereum.berlin.fork".
...
Axiom ethereum_berlin_imports :
  AreImported globals "ethereum.berlin" [ "vm" ].

Axiom ethereum_berlin_blocks_imports :
  AreImported globals "ethereum.berlin.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_berlin_bloom_imports :
  AreImported globals "ethereum.berlin.bloom" [ "logs_bloom" ].

Axiom ethereum_berlin_fork_types_imports :
  AreImported globals "ethereum.berlin.fork_types" [ "Address"; "Bloom"; "Root" ].

Axiom ethereum_berlin_state_imports :
  AreImported globals "ethereum.berlin.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_berlin_transactions_imports :
  AreImported globals "ethereum.berlin.transactions" [ "TX_ACCESS_LIST_ADDRESS_COST"; "TX_ACCESS_LIST_STORAGE_KEY_COST"; "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "AccessListTransaction"; "LegacyTransaction"; "Transaction"; "decode_transaction"; "encode_transaction" ].

Axiom ethereum_berlin_trie_imports :
  AreImported globals "ethereum.berlin.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_berlin_utils_message_imports :
  AreImported globals "ethereum.berlin.utils.message" [ "prepare_message" ].

Axiom ethereum_berlin_vm_interpreter_imports :
  AreImported globals "ethereum.berlin.vm.interpreter" [ "process_message_call" ].
