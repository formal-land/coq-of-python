...
Axiom ethereum_berlin_state_begin_transaction :
  IsGlobalAlias globals ethereum.berlin.state.globals "begin_transaction".
Axiom ethereum_berlin_state_commit_transaction :
  IsGlobalAlias globals ethereum.berlin.state.globals "commit_transaction".
Axiom ethereum_berlin_state_destroy_storage :
  IsGlobalAlias globals ethereum.berlin.state.globals "destroy_storage".
Axiom ethereum_berlin_state_increment_nonce :
  IsGlobalAlias globals ethereum.berlin.state.globals "increment_nonce".
Axiom ethereum_berlin_state_mark_account_created :
  IsGlobalAlias globals ethereum.berlin.state.globals "mark_account_created".
Axiom ethereum_berlin_state_move_ether :
  IsGlobalAlias globals ethereum.berlin.state.globals "move_ether".
Axiom ethereum_berlin_state_rollback_transaction :
  IsGlobalAlias globals ethereum.berlin.state.globals "rollback_transaction".
Axiom ethereum_berlin_state_set_code :
  IsGlobalAlias globals ethereum.berlin.state.globals "set_code".
Axiom ethereum_berlin_state_touch_account :
  IsGlobalAlias globals ethereum.berlin.state.globals "touch_account".
...
Axiom ethereum_berlin_vm_gas_GAS_CODE_DEPOSIT :
  IsGlobalAlias globals ethereum.berlin.vm.gas.globals "GAS_CODE_DEPOSIT".
...
Axiom ethereum_berlin_vm_exceptions_AddressCollision :
  IsGlobalAlias globals ethereum.berlin.vm.exceptions.globals "AddressCollision".
Axiom ethereum_berlin_vm_exceptions_ExceptionalHalt :
  IsGlobalAlias globals ethereum.berlin.vm.exceptions.globals "ExceptionalHalt".
Axiom ethereum_berlin_vm_exceptions_InvalidOpcode :
  IsGlobalAlias globals ethereum.berlin.vm.exceptions.globals "InvalidOpcode".
...
Axiom ethereum_berlin_vm_exceptions_StackDepthLimitError :
  IsGlobalAlias globals ethereum.berlin.vm.exceptions.globals "StackDepthLimitError".

Require ethereum.berlin.vm.instructions.__init__.
Axiom ethereum_berlin_vm_instructions___init___Ops :
  IsGlobalAlias globals ethereum.berlin.vm.instructions.__init__.globals "Ops".
Axiom ethereum_berlin_vm_instructions___init___op_implementation :
  IsGlobalAlias globals ethereum.berlin.vm.instructions.__init__.globals "op_implementation".

Require ethereum.berlin.vm.runtime.
Axiom ethereum_berlin_vm_runtime_get_valid_jump_destinations :
  IsGlobalAlias globals ethereum.berlin.vm.runtime.globals "get_valid_jump_destinations".
