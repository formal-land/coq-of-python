...
Definition globals : string := "ethereum.berlin.vm.instructions.memory".
...
Axiom ethereum_berlin_vm_gas_imports :
  AreImported globals "ethereum.berlin.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
