...
Definition globals : string := "ethereum.berlin.vm.instructions.environment".
...
Axiom ethereum_berlin_fork_types_imports :
  AreImported globals "ethereum.berlin.fork_types" [ "EMPTY_ACCOUNT" ].
...
Axiom ethereum_berlin_utils_address_imports :
  AreImported globals "ethereum.berlin.utils.address" [ "to_address" ].

Axiom ethereum_berlin_vm_memory_imports :
  AreImported globals "ethereum.berlin.vm.memory" [ "buffer_read"; "memory_write" ].

Axiom ethereum_berlin_vm_imports :
  AreImported globals "ethereum.berlin.vm" [ "Evm" ].

Axiom ethereum_berlin_vm_exceptions_imports :
  AreImported globals "ethereum.berlin.vm.exceptions" [ "OutOfBoundsRead" ].

Axiom ethereum_berlin_vm_gas_imports :
  AreImported globals "ethereum.berlin.vm.gas" [ "GAS_BASE"; "GAS_COLD_ACCOUNT_ACCESS"; "GAS_COPY"; "GAS_FAST_STEP"; "GAS_RETURN_DATA_COPY"; "GAS_VERY_LOW"; "GAS_WARM_ACCESS"; "calculate_gas_extend_memory"; "charge_gas" ].
