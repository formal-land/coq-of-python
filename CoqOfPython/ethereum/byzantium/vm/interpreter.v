...
Definition globals : string := "ethereum.byzantium.vm.interpreter".
...
Axiom ethereum_byzantium_state_imports :
  AreImported globals "ethereum.byzantium.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "begin_transaction"; "commit_transaction"; "destroy_storage"; "increment_nonce"; "move_ether"; "rollback_transaction"; "set_code"; "touch_account" ].

Axiom ethereum_byzantium_vm_imports :
  AreImported globals "ethereum.byzantium.vm" [ "Message" ].

Axiom ethereum_byzantium_vm_gas_imports :
  AreImported globals "ethereum.byzantium.vm.gas" [ "GAS_CODE_DEPOSIT"; "charge_gas" ].

Axiom ethereum_byzantium_vm_precompiled_contracts_mapping_imports :
  AreImported globals "ethereum.byzantium.vm.precompiled_contracts.mapping" [ "PRE_COMPILED_CONTRACTS" ].

Axiom ethereum_byzantium_vm_imports :
  AreImported globals "ethereum.byzantium.vm" [ "Environment"; "Evm" ].

Axiom ethereum_byzantium_vm_exceptions_imports :
  AreImported globals "ethereum.byzantium.vm.exceptions" [ "AddressCollision"; "ExceptionalHalt"; "InvalidOpcode"; "OutOfGasError"; "Revert"; "StackDepthLimitError" ].

Axiom ethereum_byzantium_vm_instructions_imports :
  AreImported globals "ethereum.byzantium.vm.instructions" [ "Ops"; "op_implementation" ].

Axiom ethereum_byzantium_vm_runtime_imports :
  AreImported globals "ethereum.byzantium.vm.runtime" [ "get_valid_jump_destinations" ].
