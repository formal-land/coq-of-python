...
Axiom ethereum_byzantium_state_begin_transaction :
  IsGlobalAlias globals ethereum.byzantium.state.globals "begin_transaction".
Axiom ethereum_byzantium_state_commit_transaction :
  IsGlobalAlias globals ethereum.byzantium.state.globals "commit_transaction".
Axiom ethereum_byzantium_state_destroy_storage :
  IsGlobalAlias globals ethereum.byzantium.state.globals "destroy_storage".
Axiom ethereum_byzantium_state_increment_nonce :
  IsGlobalAlias globals ethereum.byzantium.state.globals "increment_nonce".
Axiom ethereum_byzantium_state_move_ether :
  IsGlobalAlias globals ethereum.byzantium.state.globals "move_ether".
Axiom ethereum_byzantium_state_rollback_transaction :
  IsGlobalAlias globals ethereum.byzantium.state.globals "rollback_transaction".
Axiom ethereum_byzantium_state_set_code :
  IsGlobalAlias globals ethereum.byzantium.state.globals "set_code".
Axiom ethereum_byzantium_state_touch_account :
  IsGlobalAlias globals ethereum.byzantium.state.globals "touch_account".
...
Axiom ethereum_byzantium_vm_gas_GAS_CODE_DEPOSIT :
  IsGlobalAlias globals ethereum.byzantium.vm.gas.globals "GAS_CODE_DEPOSIT".
Axiom ethereum_byzantium_vm_gas_charge_gas :
  IsGlobalAlias globals ethereum.byzantium.vm.gas.globals "charge_gas".

Require ethereum.byzantium.vm.precompiled_contracts.mapping.
Axiom ethereum_byzantium_vm_precompiled_contracts_mapping_PRE_COMPILED_CONTRACTS :
  IsGlobalAlias globals ethereum.byzantium.vm.precompiled_contracts.mapping.globals "PRE_COMPILED_CONTRACTS".
...
Axiom ethereum_byzantium_vm_exceptions_AddressCollision :
  IsGlobalAlias globals ethereum.byzantium.vm.exceptions.globals "AddressCollision".
Axiom ethereum_byzantium_vm_exceptions_ExceptionalHalt :
  IsGlobalAlias globals ethereum.byzantium.vm.exceptions.globals "ExceptionalHalt".
Axiom ethereum_byzantium_vm_exceptions_InvalidOpcode :
  IsGlobalAlias globals ethereum.byzantium.vm.exceptions.globals "InvalidOpcode".
Axiom ethereum_byzantium_vm_exceptions_OutOfGasError :
  IsGlobalAlias globals ethereum.byzantium.vm.exceptions.globals "OutOfGasError".
Axiom ethereum_byzantium_vm_exceptions_Revert :
  IsGlobalAlias globals ethereum.byzantium.vm.exceptions.globals "Revert".
Axiom ethereum_byzantium_vm_exceptions_StackDepthLimitError :
  IsGlobalAlias globals ethereum.byzantium.vm.exceptions.globals "StackDepthLimitError".

Require ethereum.byzantium.vm.instructions.__init__.
Axiom ethereum_byzantium_vm_instructions___init___Ops :
  IsGlobalAlias globals ethereum.byzantium.vm.instructions.__init__.globals "Ops".
Axiom ethereum_byzantium_vm_instructions___init___op_implementation :
  IsGlobalAlias globals ethereum.byzantium.vm.instructions.__init__.globals "op_implementation".

Require ethereum.byzantium.vm.runtime.
Axiom ethereum_byzantium_vm_runtime_get_valid_jump_destinations :
  IsGlobalAlias globals ethereum.byzantium.vm.runtime.globals "get_valid_jump_destinations".
