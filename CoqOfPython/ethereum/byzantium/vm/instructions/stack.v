...
Definition globals : string := "ethereum.byzantium.vm.instructions.stack".
...
Axiom ethereum_byzantium_vm_imports :
  AreImported globals "ethereum.byzantium.vm" [ "Evm"; "stack" ].

Axiom ethereum_byzantium_vm_exceptions_imports :
  AreImported globals "ethereum.byzantium.vm.exceptions" [ "StackUnderflowError" ].

Axiom ethereum_byzantium_vm_gas_imports :
  AreImported globals "ethereum.byzantium.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "charge_gas" ].

Axiom ethereum_byzantium_vm_memory_imports :
  AreImported globals "ethereum.byzantium.vm.memory" [ "buffer_read" ].
