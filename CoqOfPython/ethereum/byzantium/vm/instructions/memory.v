...
Definition globals : string := "ethereum.byzantium.vm.instructions.memory".
...
Axiom ethereum_byzantium_vm_gas_imports :
  AreImported globals "ethereum.byzantium.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
