...
Definition globals : string := "ethereum.byzantium.fork".
...
Axiom ethereum_byzantium_imports :
  AreImported globals "ethereum.byzantium" [ "vm" ].

Axiom ethereum_byzantium_blocks_imports :
  AreImported globals "ethereum.byzantium.blocks" [ "Block"; "Header"; "Log"; "Receipt" ].

Axiom ethereum_byzantium_bloom_imports :
  AreImported globals "ethereum.byzantium.bloom" [ "logs_bloom" ].
...
Axiom ethereum_byzantium_state_imports :
  AreImported globals "ethereum.byzantium.state" [ "State"; "account_exists_and_is_empty"; "create_ether"; "destroy_account"; "get_account"; "increment_nonce"; "set_account_balance"; "state_root" ].

Axiom ethereum_byzantium_transactions_imports :
  AreImported globals "ethereum.byzantium.transactions" [ "TX_BASE_COST"; "TX_CREATE_COST"; "TX_DATA_COST_PER_NON_ZERO"; "TX_DATA_COST_PER_ZERO"; "Transaction" ].

Axiom ethereum_byzantium_trie_imports :
  AreImported globals "ethereum.byzantium.trie" [ "Trie"; "root"; "trie_set" ].

Axiom ethereum_byzantium_utils_message_imports :
  AreImported globals "ethereum.byzantium.utils.message" [ "prepare_message" ].

Axiom ethereum_byzantium_vm_interpreter_imports :
  AreImported globals "ethereum.byzantium.vm.interpreter" [ "process_message_call" ].
