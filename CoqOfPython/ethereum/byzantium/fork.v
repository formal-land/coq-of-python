...
Require ethereum.byzantium.__init__.
Axiom ethereum_byzantium___init___vm :
  IsGlobalAlias globals ethereum.byzantium.__init__.globals "vm".

Require ethereum.byzantium.blocks.
Axiom ethereum_byzantium_blocks_Block :
  IsGlobalAlias globals ethereum.byzantium.blocks.globals "Block".
Axiom ethereum_byzantium_blocks_Header :
  IsGlobalAlias globals ethereum.byzantium.blocks.globals "Header".
Axiom ethereum_byzantium_blocks_Log :
  IsGlobalAlias globals ethereum.byzantium.blocks.globals "Log".
Axiom ethereum_byzantium_blocks_Receipt :
  IsGlobalAlias globals ethereum.byzantium.blocks.globals "Receipt".

Require ethereum.byzantium.bloom.
Axiom ethereum_byzantium_bloom_logs_bloom :
  IsGlobalAlias globals ethereum.byzantium.bloom.globals "logs_bloom".
...
Axiom ethereum_byzantium_fork_types_Bloom :
  IsGlobalAlias globals ethereum.byzantium.fork_types.globals "Bloom".
Axiom ethereum_byzantium_fork_types_Root :
  IsGlobalAlias globals ethereum.byzantium.fork_types.globals "Root".
...
Axiom ethereum_byzantium_state_create_ether :
  IsGlobalAlias globals ethereum.byzantium.state.globals "create_ether".
Axiom ethereum_byzantium_state_destroy_account :
  IsGlobalAlias globals ethereum.byzantium.state.globals "destroy_account".
...
Axiom ethereum_byzantium_state_state_root :
  IsGlobalAlias globals ethereum.byzantium.state.globals "state_root".

Require ethereum.byzantium.transactions.
Axiom ethereum_byzantium_transactions_TX_BASE_COST :
  IsGlobalAlias globals ethereum.byzantium.transactions.globals "TX_BASE_COST".
Axiom ethereum_byzantium_transactions_TX_CREATE_COST :
  IsGlobalAlias globals ethereum.byzantium.transactions.globals "TX_CREATE_COST".
Axiom ethereum_byzantium_transactions_TX_DATA_COST_PER_NON_ZERO :
  IsGlobalAlias globals ethereum.byzantium.transactions.globals "TX_DATA_COST_PER_NON_ZERO".
Axiom ethereum_byzantium_transactions_TX_DATA_COST_PER_ZERO :
  IsGlobalAlias globals ethereum.byzantium.transactions.globals "TX_DATA_COST_PER_ZERO".
Axiom ethereum_byzantium_transactions_Transaction :
  IsGlobalAlias globals ethereum.byzantium.transactions.globals "Transaction".

Require ethereum.byzantium.trie.
Axiom ethereum_byzantium_trie_Trie :
  IsGlobalAlias globals ethereum.byzantium.trie.globals "Trie".
Axiom ethereum_byzantium_trie_root :
  IsGlobalAlias globals ethereum.byzantium.trie.globals "root".
Axiom ethereum_byzantium_trie_trie_set :
  IsGlobalAlias globals ethereum.byzantium.trie.globals "trie_set".

Require ethereum.byzantium.utils.message.
Axiom ethereum_byzantium_utils_message_prepare_message :
  IsGlobalAlias globals ethereum.byzantium.utils.message.globals "prepare_message".

Require ethereum.byzantium.vm.interpreter.
Axiom ethereum_byzantium_vm_interpreter_process_message_call :
  IsGlobalAlias globals ethereum.byzantium.vm.interpreter.globals "process_message_call".
