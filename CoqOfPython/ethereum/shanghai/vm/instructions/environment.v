...
Definition globals : string := "ethereum.shanghai.vm.instructions.environment".
...
Axiom ethereum_shanghai_fork_types_imports :
  AreImported globals "ethereum.shanghai.fork_types" [ "EMPTY_ACCOUNT" ].

Axiom ethereum_shanghai_state_imports :
  AreImported globals "ethereum.shanghai.state" [ "get_account" ].

Axiom ethereum_shanghai_utils_address_imports :
  AreImported globals "ethereum.shanghai.utils.address" [ "to_address" ].

Axiom ethereum_shanghai_vm_memory_imports :
  AreImported globals "ethereum.shanghai.vm.memory" [ "buffer_read"; "memory_write" ].
...
Axiom ethereum_shanghai_vm_exceptions_imports :
  AreImported globals "ethereum.shanghai.vm.exceptions" [ "OutOfBoundsRead" ].

Axiom ethereum_shanghai_vm_gas_imports :
  AreImported globals "ethereum.shanghai.vm.gas" [ "GAS_BASE"; "GAS_COLD_ACCOUNT_ACCESS"; "GAS_COPY"; "GAS_FAST_STEP"; "GAS_RETURN_DATA_COPY"; "GAS_VERY_LOW"; "GAS_WARM_ACCESS"; "calculate_gas_extend_memory"; "charge_gas" ].
