...
Definition globals : string := "ethereum.shanghai.vm.instructions.log".
...
Axiom ethereum_shanghai_vm_exceptions_imports :
  AreImported globals "ethereum.shanghai.vm.exceptions" [ "WriteInStaticContext" ].

Axiom ethereum_shanghai_vm_gas_imports :
  AreImported globals "ethereum.shanghai.vm.gas" [ "GAS_LOG"; "GAS_LOG_DATA"; "GAS_LOG_TOPIC"; "calculate_gas_extend_memory"; "charge_gas" ].

Axiom ethereum_shanghai_vm_memory_imports :
  AreImported globals "ethereum.shanghai.vm.memory" [ "memory_read_bytes" ].

Axiom ethereum_shanghai_vm_stack_imports :
  AreImported globals "ethereum.shanghai.vm.stack" [ "pop" ].
