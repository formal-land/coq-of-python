...
Definition globals : string := "ethereum.shanghai.vm.instructions.memory".
...
Axiom ethereum_shanghai_vm_gas_imports :
  AreImported globals "ethereum.shanghai.vm.gas" [ "GAS_BASE"; "GAS_VERY_LOW"; "calculate_gas_extend_memory"; "charge_gas" ].
