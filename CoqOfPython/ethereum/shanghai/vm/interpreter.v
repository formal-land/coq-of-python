...
Definition globals : string := "ethereum.shanghai.vm.interpreter".
...
Axiom ethereum_shanghai_blocks_imports :
  AreImported globals "ethereum.shanghai.blocks" [ "Log" ].
...
Axiom ethereum_shanghai_state_imports :
  AreImported globals "ethereum.shanghai.state" [ "account_exists_and_is_empty"; "account_has_code_or_nonce"; "begin_transaction"; "commit_transaction"; "destroy_storage"; "increment_nonce"; "mark_account_created"; "move_ether"; "rollback_transaction"; "set_code"; "touch_account" ].

Axiom ethereum_shanghai_vm_imports :
  AreImported globals "ethereum.shanghai.vm" [ "Message" ].

Axiom ethereum_shanghai_vm_gas_imports :
  AreImported globals "ethereum.shanghai.vm.gas" [ "GAS_CODE_DEPOSIT"; "charge_gas" ].

Axiom ethereum_shanghai_vm_precompiled_contracts_mapping_imports :
  AreImported globals "ethereum.shanghai.vm.precompiled_contracts.mapping" [ "PRE_COMPILED_CONTRACTS" ].

Axiom ethereum_shanghai_vm_imports :
  AreImported globals "ethereum.shanghai.vm" [ "Environment"; "Evm" ].

Axiom ethereum_shanghai_vm_exceptions_imports :
  AreImported globals "ethereum.shanghai.vm.exceptions" [ "AddressCollision"; "ExceptionalHalt"; "InvalidContractPrefix"; "InvalidOpcode"; "OutOfGasError"; "Revert"; "StackDepthLimitError" ].
...
Axiom ethereum_shanghai_vm_runtime_imports :
  AreImported globals "ethereum.shanghai.vm.runtime" [ "get_valid_jump_destinations" ].
