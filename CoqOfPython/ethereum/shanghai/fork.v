...
Definition check_transaction : Value.t -> Value.t -> M :=
  ...
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.gt_e (| M.get_field (| M.get_name (| globals, "tx" |), "max_fee_per_gas" |), M.get_field (| M.get_name (| globals, "tx" |), "max_priority_fee_per_gas" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.gt_e (| M.get_field (| M.get_name (| globals, "tx" |), "max_fee_per_gas" |), M.get_name (| globals, "base_fee_per_gas" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
    ...
    M.get_name (| globals, "ensure" |),
    make_list [
      Compare.gt_e (| M.get_field (| M.get_name (| globals, "tx" |), "gas_price" |), M.get_name (| globals, "base_fee_per_gas" |) |);
      M.get_name (| globals, "InvalidBlock" |)
    ],
    make_dict []
  |) in
